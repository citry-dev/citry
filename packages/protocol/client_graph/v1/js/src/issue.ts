...
/** ES2020-compatible own-property check used at strict boundaries. */
export const hasOwn = (value: object, key: PropertyKey): boolean =>
	// biome-ignore lint/suspicious/noPrototypeBuiltins: Object.hasOwn is newer than the browser target.
