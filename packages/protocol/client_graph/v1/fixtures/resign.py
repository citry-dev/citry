...
fixture content:
    ...
    python packages/protocol/client_graph/v1/fixtures/resign.py            # every listed fixture
    python packages/protocol/client_graph/v1/fixtures/resign.py NAME.json  # specific files
