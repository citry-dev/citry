...
from citry import Citry, Component, Const, SlotInput
...
class ExpansionPanel(Component):
    ...
    def template_data(self, kwargs, slots):
        return {
            ...
            "icon_attrs": Const({"style": "width: fit-content;"}),
        }
...
class Tags(Component):
    ...
    def template_data(self, kwargs, slots):
        ...
        return {
            ...
            "attrs": kwargs.attrs,
            "remove_btn_attrs": Const({"class": "!py-1"}),
            "add_btn_attrs": Const({"class": "!py-1"}),
            "has_title": bool(self.raw_slots.get("title")),
        }
...
class ProjectUserAction(Component):
    ...
    def template_data(self, kwargs, slots):
        return {
            ...
            "icon_attrs": Const({"class": "p-2", "data-benchmark-user-delete": str(kwargs.role_id)}),
        }
...
class ProjectOutputForm(Component):
    ...
    def template_data(self, kwargs, slots):
        ...
        return {
            ...
            "placeholder": Const(OUTPUT_DESCRIPTION_PLACEHOLDER),
            "add_btn_attrs": Const({"data-benchmark-add-attachment": True}),
            "save_btn_attrs": Const({}),
            "attach_js_props": {
