"""
Pinned static compatibility model for Alpine CSP 3.17.1 expressions.
...
ALPINE_CSP_COMPATIBILITY_VERSION = "3.17.1"
...
def classify_alpine_csp(expression: BrowserExpression) -> AlpineCspClassification:
    """Classify one extracted browser host against Alpine CSP 3.17.1."""
