...
def test_scaling_report_records_counts_without_claiming_timing_gates():
    ...
    assert [(result["profile"], result["count"]) for result in report["results"]] == [
        ...
        ("alert-instances", 1),
        ("button-instances", 1),
        ("split-button-instances", 1),
        ("tags-input-instances", 1),
        ("tags-input-tags", 1),
        ("avatar-instances", 1),
        ("image-instances", 1),
        ("badge-instances", 1),
        ...
        ("tooltip-instances", 1),
        ("menu-instances", 1),
        ("context-menu-instances", 1),
        ("command-palette-closed-instances", 1),
        ("command-palette-open-instances", 1),
        ("command-palette-commands", 1),
        ("accordion-items", 10),
        ("disclosure-instances", 10),
        ("alert-instances", 10),
        ("button-instances", 10),
        ("split-button-instances", 10),
        ("tags-input-instances", 10),
        ("tags-input-tags", 10),
        ("avatar-instances", 10),
        ("image-instances", 10),
        ("badge-instances", 10),
        ...
        ("menu-instances", 10),
        ("context-menu-instances", 10),
        ("command-palette-closed-instances", 10),
        ("command-palette-open-instances", 10),
        ("command-palette-commands", 10),
    ]
