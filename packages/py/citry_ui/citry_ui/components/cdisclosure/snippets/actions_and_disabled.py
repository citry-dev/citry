...
class DisclosureActionsAndDisabled(Component):
    template = """
      ...
      >
        ...
        <fieldset :disabled="fieldsetDisabled">
          <legend>
            <label><input type="checkbox" v-model="fieldsetDisabled" /> Disable native fieldset</label>
          </legend>
          <c-CDisclosure>
    ...
    js = """
      $component({
        data() {
          return {
            disabled:false, fieldsetDisabled:false
          };
        },
      });
    """
