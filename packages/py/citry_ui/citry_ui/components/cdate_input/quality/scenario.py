        ...
        template = """
          <section class="citry-ui-quality-stack date-input-quality" aria-labelledby="date-input-states-title" >
            ...
            <div class="citry-ui-quality-grid">
              <c-CDateInput value="2026-08-19" c-attrs="{'aria-label':'Controlled date','data-quality-states':'controlled native-event refusal acceptance'}" :value="day" @input="last=$event.currentTarget.value" />
            ...
            <output v-text="last">No DateInput action yet</output>
          </section>
        """
        js = """
          $component({
            data() {
              return {
                day:'2026-08-19',last:'No DateInput action yet'
              };
            },
          });
        """
