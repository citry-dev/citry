...
class CAccordion(LibraryComponent):
    ...
    css = """
      @layer citry-ui.theme {
        :where(.cui-accordion) {
          --_cui-accordion-background: var(--cui-accordion-background, Canvas);
          --_cui-accordion-foreground: var(--cui-accordion-foreground, CanvasText);
          --_cui-accordion-border-color: var(
            --cui-accordion-border-color,
            color-mix(in srgb, currentColor 22%, transparent)
          );
          --_cui-accordion-border-width: var(--cui-accordion-border-width, 1px);
          --_cui-accordion-radius: var(--cui-accordion-radius, 0.75rem);
          --_cui-accordion-gap: var(--cui-accordion-gap, 0.75rem);
          --_cui-accordion-shadow: var(
            --cui-accordion-shadow,
            0 0.35rem 1rem color-mix(in srgb, CanvasText 12%, transparent)
          );
          --_cui-accordion-trigger-background: var(
            --cui-accordion-trigger-background,
            transparent
          );
          --_cui-accordion-trigger-hover-background: var(
            --cui-accordion-trigger-hover-background,
            color-mix(in srgb, currentColor 8%, transparent)
          );
          --_cui-accordion-trigger-open-background: var(
            --cui-accordion-trigger-open-background,
            color-mix(in srgb, LinkText 9%, transparent)
          );
          --_cui-accordion-trigger-open-color: var(
            --cui-accordion-trigger-open-color,
            LinkText
          );
          --_cui-accordion-focus-color: var(--cui-accordion-focus-color, Highlight);
          --_cui-accordion-indicator-color: var(
            --cui-accordion-indicator-color,
            currentColor
          );
          --_cui-accordion-trigger-padding-inline: var(
            --cui-accordion-trigger-padding-inline,
            1rem
          );
          --_cui-accordion-trigger-padding-block: var(
            --cui-accordion-trigger-padding-block,
            0.875rem
          );
          --_cui-accordion-panel-padding-inline: var(
            --cui-accordion-panel-padding-inline,
            1rem
          );
          --_cui-accordion-panel-padding-block: var(
            --cui-accordion-panel-padding-block,
            1rem
          );
          --_cui-accordion-actions-gap: var(--cui-accordion-actions-gap, 0.5rem);
          --_cui-accordion-duration: var(--cui-accordion-duration, 180ms);
          --_cui-accordion-easing: var(--cui-accordion-easing, ease-out);
          display: grid;
          min-inline-size: 0;
          overflow: visible;
          color: var(--_cui-accordion-foreground);
          font-family: ui-sans-serif, system-ui, sans-serif;
        }

        :where(.cui-accordion[data-size="sm"]) {
          --_cui-accordion-trigger-padding-inline: var(
            --cui-accordion-trigger-padding-inline,
            0.75rem
          );
        ...
        :where(.cui-accordion[data-size="lg"]) {
          --_cui-accordion-trigger-padding-inline: var(
            --cui-accordion-trigger-padding-inline,
            1.25rem
          );
        ...
        :where(.cui-accordion[data-variant="outline"]) {
          border: var(--_cui-accordion-border-width) solid var(--_cui-accordion-border-color);
          border-radius: var(--_cui-accordion-radius);
          background: var(--_cui-accordion-background);
        }

        :where(.cui-accordion[data-variant="soft"]) {
          border-radius: var(--_cui-accordion-radius);
          background: color-mix(
            in srgb,
            var(--_cui-accordion-foreground) 5%,
            var(--_cui-accordion-background)
          );
        }

        :where(.cui-accordion[data-variant="separated"]) {
          gap: var(--_cui-accordion-gap);
        }

        :where(.cui-accordion > .cui-accordion__item) {
          min-inline-size: 0;
          overflow: visible;
          background: transparent;
        }

        :where(.cui-accordion[data-variant="outline"] > .cui-accordion__item + .cui-accordion__item),
        :where(.cui-accordion[data-variant="soft"] > .cui-accordion__item + .cui-accordion__item),
        :where(.cui-accordion[data-variant="plain"] > .cui-accordion__item + .cui-accordion__item) {
          border-block-start: var(--_cui-accordion-border-width) solid
            var(--_cui-accordion-border-color);
        }

        :where(.cui-accordion[data-variant="separated"] > .cui-accordion__item) {
          border: var(--_cui-accordion-border-width) solid var(--_cui-accordion-border-color);
          border-radius: var(--_cui-accordion-radius);
          box-shadow: var(--_cui-accordion-shadow);
          background: var(--_cui-accordion-background);
        }

        :where(.cui-accordion__header) {
          display: grid;
        ...
        :where(.cui-accordion__heading) {
          min-inline-size: 0;
          margin: 0;
          font: inherit;
        }

        :where(.cui-accordion__trigger) {
          display: flex;
          inline-size: 100%;
          min-inline-size: 0;
          align-items: center;
          ...
          gap: 0.75rem;
          padding-block: var(--_cui-accordion-trigger-padding-block);
          padding-inline: var(--_cui-accordion-trigger-padding-inline);
          border: 0;
          border-radius: 0;
          background: var(--_cui-accordion-trigger-background);
          color: inherit;
          font: inherit;
          font-weight: 650;
          line-height: 1.35;
        ...
        :where(
          .cui-accordion:is([data-variant="outline"], [data-variant="soft"])
          > .cui-accordion__item:first-child
          > .cui-accordion__header
          > .cui-accordion__heading
          > .cui-accordion__trigger
        ),
        :where(
          .cui-accordion[data-variant="separated"]
          > .cui-accordion__item
          > .cui-accordion__header
          > .cui-accordion__heading
          > .cui-accordion__trigger
        ) {
          border-start-start-radius: var(--_cui-accordion-radius);
        }

        :where(
          .cui-accordion:is([data-variant="outline"], [data-variant="soft"])
          > .cui-accordion__item:first-child
          > .cui-accordion__header:not(:has(> .cui-accordion__actions))
          > .cui-accordion__heading
          > .cui-accordion__trigger
        ),
        :where(
          ...
          border-start-end-radius: var(--_cui-accordion-radius);
        }

        :where(
          .cui-accordion:is([data-variant="outline"], [data-variant="soft"])
          > .cui-accordion__item:last-child[data-state="closed"]
          > .cui-accordion__header
          > .cui-accordion__heading
          > .cui-accordion__trigger
        ),
        :where(
          .cui-accordion[data-variant="separated"]
          > .cui-accordion__item[data-state="closed"]
          > .cui-accordion__header
          > .cui-accordion__heading
          > .cui-accordion__trigger
        ) {
          border-end-start-radius: var(--_cui-accordion-radius);
        }
        ...
        :where(
          ...
          border-end-end-radius: var(--_cui-accordion-radius);
        }

        :where(.cui-accordion__trigger:not(:disabled):not([aria-disabled="true"]):hover) {
          background: var(--_cui-accordion-trigger-hover-background);
        }

        :where(.cui-accordion__trigger[data-state="open"]) {
          background: var(--_cui-accordion-trigger-open-background);
          color: var(--_cui-accordion-trigger-open-color);
        }

        :where(.cui-accordion__trigger:focus-visible) {
          position: relative;
          z-index: 1;
          outline: 2px solid var(--_cui-accordion-focus-color);
          outline-offset: -2px;
        }

        :where(.cui-accordion__trigger:disabled) {
          cursor: not-allowed;
          opacity: 0.58;
        }

        :where(.cui-accordion__title) {
          min-inline-size: 0;
          overflow-wrap: anywhere;
        }

        :where(.cui-accordion__indicator) {
          display: inline-grid;
          flex: 0 0 auto;
          inline-size: 1.1em;
          block-size: 1.1em;
          place-items: center;
          color: var(--_cui-accordion-indicator-color);
          transition: transform var(--_cui-accordion-duration) var(--_cui-accordion-easing);
        }

        :where(.cui-accordion__indicator > svg) {
          display: block;
          inline-size: 100%;
          block-size: 100%;
        }

        :where(.cui-accordion__trigger[data-state="open"] > .cui-accordion__indicator) {
          transform: rotate(180deg);
        }

        :where(
          .cui-accordion[data-indicator-pos="start"]
          > .cui-accordion__item
          > .cui-accordion__header
          > .cui-accordion__heading
          > .cui-accordion__trigger
          > .cui-accordion__indicator
        ) {
          order: -1;
        }

        :where(.cui-accordion__indicator[hidden]),
        :where(.cui-accordion__panel[hidden]) {
          display: none !important;
        }

        :where(.cui-accordion__actions) {
          display: flex;
          min-inline-size: 0;
          flex-wrap: wrap;
          align-items: center;
          gap: var(--_cui-accordion-actions-gap);
          padding-inline-end: var(--_cui-accordion-trigger-padding-inline);
          overflow-wrap: anywhere;
        }
        ...
        :where(.cui-accordion__panel) {
          min-inline-size: 0;
          overflow: visible;
        }

        :where(.cui-accordion__body) {
          min-inline-size: 0;
          padding-block: var(--_cui-accordion-panel-padding-block);
          padding-inline: var(--_cui-accordion-panel-padding-inline);
          overflow: visible;
          overflow-wrap: anywhere;
          line-height: 1.55;
        }
        ...
        @media (forced-colors: active) {
          :where(.cui-accordion) {
            --_cui-accordion-border-color: CanvasText;
            --_cui-accordion-focus-color: Highlight;
            --_cui-accordion-trigger-open-color: CanvasText;
          }
        }
