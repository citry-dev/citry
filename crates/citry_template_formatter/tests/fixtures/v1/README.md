...
the built-in provider. Embedded-formatting cases lock the initial JavaScript
and CSS provider boundary. The test suite verifies that each positive pair
...
eligibility cases implemented through implementation-order step 8. Its
physical directories are capability-oriented categories; implementation-stage
identifiers remain confined to the design history rather than paths, case IDs,
schema fields, test names, or diagnostics.
