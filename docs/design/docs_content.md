...
| Community | "How do I get help, participate, maintain the project, or find ecosystem packages?" | Support, contribution, governance, people, policy, maintainer workflows, and reviewed extension and UI-library directories | Own contributor operations and current ecosystem discovery across official and independent packages, not Citry product contracts or ordinary usage guidance. | `site` |
