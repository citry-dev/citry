...
Citry pins Alpine 3.17.1, `@alpinejs/morph` 3.17.1, and `@alpinejs/csp` 3.17.1.
...
Alpine CSP 3.17.1 cannot evaluate arrow functions here. Move the logic to
...
6. **Complete (2026-08-12).** Build the version-pinned CSP compatibility
   ...
   1. run the development-only executable spike against the real Alpine 3.17.1
...
10. **Complete (revised 2026-08-13).** Check every Citry UI production
    component definition against the pinned Alpine 3.17.1 subset in CI. The
...
3.17.1 corpus, and phase 6.2 added the production checker, stable diagnostic,
...
- [Alpine 3.17.1 release](https://github.com/alpinejs/alpine/releases/tag/v3.17.1)
