...
def main() -> None:
    ...
    report["build"] = json.loads((ROOT / "benchmarks/results/performance-render/render-modules-build.json").read_text())
    (ROOT / "benchmarks/results/performance-render/render-modules-lifetime.json").write_text(
