...
def main() -> None:
    ...
    report["build"] = json.loads((ROOT / "benchmarks/results/repeat-render/render-modules-build.json").read_text())
    (ROOT / "benchmarks/results/repeat-render/render-modules-lifetime.json").write_text(
