...
def main() -> None:
    ...
    report["build"] = json.loads((ROOT / "benchmarks/results/performance-render/settlement-abi312-build.json").read_text())
    (ROOT / "benchmarks/results/performance-render/settlement-abi312-large-lifetime.json").write_text(
