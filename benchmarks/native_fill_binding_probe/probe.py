"""Measure grouped fill binding against the existing native ownership backend."""
...
from benchmarks.native_fill_binding_probe.adapter import install_binding  # noqa: E402
...
ENABLE, BASE_ENABLE, RESTORE = install_binding(NATIVE, STATS)


def install(changed: bool) -> None:
    """Compare grouped fill binding with the existing native ownership backend."""
