"""Measure combined native slot preparation and direct record export against the existing native ownership backend."""
...
def install(changed: bool) -> None:
    """Compare combined native slot preparation and direct record export with the existing native ownership backend."""
