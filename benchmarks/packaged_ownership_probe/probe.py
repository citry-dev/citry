"""Measure packaged ownership storage through the qualified experimental capture adapters."""
...
from benchmarks.native_combined_capture_probe.adapter import install_combined  # noqa: E402
...
ENABLE, BASE_ENABLE, RESTORE = install_combined(NATIVE, STATS)


def install(changed: bool) -> None:
    """Compare combined native slot preparation and direct record export with production ownership."""
...
def main() -> None:
    ...
    report = {
        ...
        "ownership_backend": "packaged binding with experimental capture adapters",
