...
def main() -> None:
    ...
    report = {
        ...
        "experiment": "compile the pipeline with explicit settlement state",
        ...
        "build": json.loads((ROOT / "benchmarks/results/performance-render/settlement-state-build.json").read_text()),
        "hashes": {
