"""Measure existing native ownership storage with current production rendering."""
...
from benchmarks.ownership_journal_probe.storage_probe import TABLES, install_storage  # noqa: E402
...
ENABLE, RESTORE = install_storage(NATIVE, STATS)


def install(changed: bool) -> None:
    """Switch the existing backend without changing its capture or retirement code."""
