"""Build the explicit-state rendering pipeline against the Python 3.10 stable ABI."""
...
BUILD = Path("/tmp/citry-settlement-abi310")  # noqa: S108 - isolated experiment
...
def main() -> None:
    ...
    for name, relative in SOURCES.items():
        ...
        extensions.append(
            ...
            "define_macros=[('Py_LIMITED_API', '0x030A0000')], py_limited_api=True)"
        )
    setup = "\n".join(
        [
