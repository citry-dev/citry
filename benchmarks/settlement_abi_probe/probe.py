...
def main() -> None:
    ...
    report = {
        ...
        "experiment": "compile the explicit-state pipeline using the Python 3.10 stable ABI",
        ...
        "build": json.loads((ROOT / "benchmarks/results/performance-render/settlement-abi310-build.json").read_text()),
        "hashes": {
