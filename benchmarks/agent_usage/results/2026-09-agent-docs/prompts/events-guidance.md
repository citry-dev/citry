...
Use https://citry.dev/llms.txt to find the relevant documentation. Fetch the linked Markdown guides and API references for this task, check compatibility with the installed Citry version, and verify the implementation by running it.
