"""Measure native slot region preparation against the existing native ownership backend."""
...
from benchmarks.native_slot_region_probe.adapter import install_region  # noqa: E402
...
ENABLE, BASE_ENABLE, RESTORE = install_region(NATIVE, STATS)


def install(changed: bool) -> None:
    """Compare native slot region preparation with the existing native ownership backend."""
