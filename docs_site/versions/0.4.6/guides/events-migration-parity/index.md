...
url: https://citry.dev/v/0.4.6/guides/events-migration-parity/
...
- [Component.View](/v/0.4.6/guides/migrate-from-component-view/)
- [django-unicorn](/v/0.4.6/guides/migrate-from-django-unicorn/)
- [Tetra](/v/0.4.6/guides/migrate-from-tetra/)
- [livecomponents](/v/0.4.6/guides/migrate-from-livecomponents/)
...
[Server events](/v/0.4.6/events/) and [Security](/v/0.4.6/security/).