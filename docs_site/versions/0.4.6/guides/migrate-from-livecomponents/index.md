...
url: https://citry.dev/v/0.4.6/guides/migrate-from-livecomponents/
...
[Events migration parity matrix](/v/0.4.6/guides/events-migration-parity/) records
...
Continue with [State](/v/0.4.6/events/state/) and [event actions](/v/0.4.6/events/actions/) for
fresh renders, and [Security](/v/0.4.6/security/) for cache, CSRF, and
