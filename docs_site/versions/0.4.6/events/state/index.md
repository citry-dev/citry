...
url: https://citry.dev/v/0.4.6/events/state/
...
[`State`](/v/0.4.6/reference/component/#citry-component-state) holds the small values that a later server
...
input. See [Security](/v/0.4.6/security/#treat-state-as-client-input).
