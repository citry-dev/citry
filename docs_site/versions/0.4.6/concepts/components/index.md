---
title: Components
url: https://citry.dev/v/0.4.6/concepts/components/
...
[`Component`](/v/0.4.6/reference/component/#citry-component). Most components bring together:
...
Set [`template`](/v/0.4.6/reference/component/#citry-component-template) to the markup you want the
...
[`Kwargs`](/v/0.4.6/reference/component/#citry-component-kwargs). By default, Citry makes those values
...
default [`template_data()`](/v/0.4.6/reference/component/#citry-component-template-data) returns the
...
[Inputs and validation](/v/0.4.6/concepts/inputs-and-validation/) for required
...
[`TemplateData`](/v/0.4.6/reference/component/#citry-component-templatedata) when you also want Citry to
...
Python code. Set [`template_file`](/v/0.4.6/reference/component/#citry-component-template-file) when you
...
[`on_render()`](/v/0.4.6/reference/component/#citry-component-on-render) hook supplies its complete output.

## Compose first, render when you need HTML

Calling a component class returns a
[`CitryElement`](/v/0.4.6/reference/rendering/#citry-citryelement), not a live `Component` instance and not
...
[Slots](/v/0.4.6/concepts/slots/) for template and Python examples.
...
fresh rendered occurrence. [Rendering](/v/0.4.6/concepts/rendering/) explains when to
