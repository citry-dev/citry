---
title: Benchmarks
url: https://citry.dev/v/0.4.6/about/benchmarks/
...
- [Performance](/v/0.4.6/advanced/performance/) covers opt-in reuse with
  [`Const`](/v/0.4.6/reference/rendering/#citry-const) and pure component classes.