---
title: Checkbox
url: https://citry.dev/v/0.4.6/ui-library/components/checkbox/
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/compose-checkbox/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/configuration/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/forms-and-validation/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/controlled-states/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/indeterminate/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/field-states/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/label-and-description/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/variants-and-sizes/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/checkbox/_previews/theme-customization/)
