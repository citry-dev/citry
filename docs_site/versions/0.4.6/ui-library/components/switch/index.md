---
title: Switch
url: https://citry.dev/v/0.4.6/ui-library/components/switch/
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/basic/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/descriptions/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/forms/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/presentation/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/field/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/semantics/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/switch/_previews/customization/)
