---
title: Listbox
url: https://citry.dev/v/0.4.6/ui-library/components/listbox/
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/single-selection/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/multiple-selection/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/groups/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/disabled/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/keyboard/)
...
[Open the rendered preview](/v/0.4.6/ui-library/components/listbox/_previews/customization/)
...
| <span id="listbox-css-clistbox-css-variables-cui-listbox-muted-color"></span>`--cui-listbox-muted-color` | `color` | Disabled and secondary foreground. | `light #475467; dark #a4a7ae` |
