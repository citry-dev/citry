...
url: https://citry.dev/v/0.4.6/advanced/dependency-files/
...
`css_file`. See
[Component JavaScript and CSS](/v/0.4.6/advanced/js-and-css-dependencies/).
...
Use [`Script`](/v/0.4.6/reference/dependencies/#citry-ext-dependencies-script) or
[`Style`](/v/0.4.6/reference/dependencies/#citry-ext-dependencies-style) to add attributes or inline content:
...
then in the directories configured on [`Citry`](/v/0.4.6/reference/citry/#citry-citry). When Citry finds
...
content. See [Web frameworks](/v/0.4.6/web-frameworks/) for mounting.
...
child. [Subclassing components](/v/0.4.6/advanced/subclassing/) explains how to extend
