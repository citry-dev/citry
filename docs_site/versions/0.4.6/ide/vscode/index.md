---
title: VS Code
url: https://citry.dev/v/0.4.6/ide/vscode/
...
[`Citry`](/v/0.4.6/reference/citry/#citry-citry) instance or a reusable
...
globals through `LintSettings`; see [Template linting](/v/0.4.6/ide/template-linting/).
...
the application's [template lint settings](/v/0.4.6/ide/template-linting/).
