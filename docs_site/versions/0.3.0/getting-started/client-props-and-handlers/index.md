...
url: https://citry.dev/v/0.3.0/getting-started/client-props-and-handlers/
...
Start with [Add browser behavior](/v/0.3.0/getting-started/browser-interactivity/) if
you have not used Alpine or [`$component`](/v/0.3.0/reference/browser-apis/#component) in Citry yet.
...
[`ChoiceButton.js`](/v/0.3.0/reference/component/#citry-component-js) declares one browser prop called
`label`:
...
The [Client interactivity](/v/0.3.0/concepts/client-interactivity/) guide covers
