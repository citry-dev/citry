---
title: Install Citry
url: https://citry.dev/v/0.3.0/getting-started/installation/
...
[`Component`](/v/0.3.0/reference/component/#citry-component) base class:
...
[build a reusable card](/v/0.3.0/getting-started/your-first-component/) with an option,
...
see [Compatibility](/v/0.3.0/about/compatibility/#building-from-source) for the
