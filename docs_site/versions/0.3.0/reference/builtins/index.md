---
title: Built-in tags
url: https://citry.dev/v/0.3.0/reference/builtins/
...
The [control-flow guide](/v/0.3.0/syntax/control-flow/) covers inline `c-if`
...
Read [Control flow](/v/0.3.0/syntax/control-flow/#loops) for unpacking, filtering,
and the `loop` helper.
...
See [Slots](/v/0.3.0/concepts/slots/) for required slots, slot data, dynamic names,
...
Read [Dynamic components](/v/0.3.0/advanced/dynamic-components/) for complete examples
