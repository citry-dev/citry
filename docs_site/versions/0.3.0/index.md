...
This very page is rendered by Citry (version 0.3.0): the docs site
...
See [Expressions](/v/0.3.0/syntax/expressions/),
[Dynamic attributes](/v/0.3.0/syntax/dynamic-attributes/),
[Control flow](/v/0.3.0/syntax/control-flow/), and
[Nested templates](/v/0.3.0/syntax/nested-templates/).
...
More in [Slots](/v/0.3.0/concepts/slots/).
...
More in [Typing and validation](/v/0.3.0/concepts/typing-and-validation/).
...
assemble attributes in Python with [format_attrs](/v/0.3.0/reference/attributes/#citry-format-attrs) and
[merge_attrs](/v/0.3.0/reference/attributes/#citry-merge-attrs).
...
More in [HTML attributes](/v/0.3.0/concepts/html-attributes/).
...
More in [Client interactivity](/v/0.3.0/concepts/client-interactivity/) and
[Alpine runtime](/v/0.3.0/advanced/alpine-runtime/).
...
More in [Server events](/v/0.3.0/events/).
...
More in [Provide and inject](/v/0.3.0/concepts/provide-and-inject/).
...
The chain runs [CitryElement](/v/0.3.0/reference/rendering/#citry-citryelement) to
[CitryRender](/v/0.3.0/reference/rendering/#citry-citryrender) to an HTML string, with the
[DepsStrategy](/v/0.3.0/reference/rendering/#citry-depsstrategy) choosing how the assets ship. More in
...
[Citry](/v/0.3.0/reference/citry/#citry-citry) instance and can also add per-component config and their
own CLI commands.
...
More in [Extensions](/v/0.3.0/advanced/extensions/).
...
Both surfaces use the backend configured on your [Citry](/v/0.3.0/reference/citry/#citry-citry)
instance. The default is process-local; Redis, disk, and Django adapters support
shared deployments. More in [Caching](/v/0.3.0/advanced/caching/).

### Performance

Most of a template is the same on every render. Promise which inputs stay the
same with [Const](/v/0.3.0/reference/rendering/#citry-const), and citry renders those parts once and reuses
...
More in [Performance](/v/0.3.0/advanced/performance/).

## Where to go next

- [Installation](/v/0.3.0/getting-started/installation/): install citry and render your
  first component.
- [Template syntax](/v/0.3.0/syntax/expressions/): expressions, dynamic attributes, and
  control flow.
- [Components](/v/0.3.0/concepts/components/) and [Slots](/v/0.3.0/concepts/slots/): the core
  building blocks.
- [Examples](/v/0.3.0/examples/): real citry components, rendered live.
- [API reference](/v/0.3.0/reference/): every public class and function.