...
url: https://citry.dev/v/0.3.0/advanced/share-components/
...
package's explicit manifest into each [`Citry`](/v/0.3.0/reference/citry/#citry-citry) instance that
should use it.

The public pieces are:

- [`LibraryComponent`](/v/0.3.0/reference/component-libraries/#citry-librarycomponent), the engine-neutral definition;
- [`ComponentLibrary`](/v/0.3.0/reference/component-libraries/#citry-componentlibrary), the ordered package manifest;
- [`Citry.register_library()`](/v/0.3.0/reference/citry/#citry-citry-register-library), the application
  startup operation; and
- [`LibraryInstallation`](/v/0.3.0/reference/component-libraries/#citry-libraryinstallation), the committed
  installation handle.
...
subclass the runtime [`SlotData`](/v/0.3.0/reference/slots/#citry-slotdata) record.
...
Registration creates a distinct concrete [`Component`](/v/0.3.0/reference/component/#citry-component) class
...
[`LibraryManifestChanged`](/v/0.3.0/reference/component-libraries/#citry-librarymanifestchanged).
...
tags. Name collisions raise [`AlreadyRegistered`](/v/0.3.0/reference/citry/#citry-alreadyregistered)
...
See [Slots](/v/0.3.0/concepts/slots/#scoped-slots-passing-data-to-the-fill) for the
...
[`LibraryComponentInvocation`](/v/0.3.0/reference/component-libraries/#citry-librarycomponentinvocation), which follows
Citry's structural [`ComponentLike`](/v/0.3.0/reference/component-libraries/#citry-componentlike) protocol. At render
...
[`LibraryComponentContextError`](/v/0.3.0/reference/component-libraries/#citry-librarycomponentcontexterror) when no
...
implementing [`ComponentLike`](/v/0.3.0/reference/component-libraries/#citry-componentlike):
...
After [`Citry.clear()`](/v/0.3.0/reference/citry/#citry-citry-clear), the handle is retired and component
lookup raises [`LibraryInstallationStale`](/v/0.3.0/reference/component-libraries/#citry-libraryinstallationstale).
