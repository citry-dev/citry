...
url: https://citry.dev/v/0.3.0/advanced/hooks/
...
methods you add to your [Component](/v/0.3.0/reference/component/#citry-component) subclass, and each one runs
as part of that component's own render, for that component only. (For hooks that
span the whole app, reach for an [Extension](/v/0.3.0/reference/extensions/#citry-extension); see
[Extensions](/v/0.3.0/advanced/extensions/).)
...
- a composed element like `OtherComponent(title="hi")`, the
  [CitryElement](/v/0.3.0/reference/rendering/#citry-citryelement) you get from calling a component
- an already-rendered [CitryRender](/v/0.3.0/reference/rendering/#citry-citryrender)
- a [Slot](/v/0.3.0/reference/slots/#citry-slot), invoked with no data
...
- On success, `result` is the finished [CitryRender](/v/0.3.0/reference/rendering/#citry-citryrender) and
  `error` is `None`.
...
`result` is a [CitryRender](/v/0.3.0/reference/rendering/#citry-citryrender), not a string. Call `str(result)`
...
[Error boundaries](/v/0.3.0/concepts/error-boundaries/) first, and drop to `on_render`
...
The two lists hold this component's [Script](/v/0.3.0/reference/dependencies/#citry-ext-dependencies-script) and
[Style](/v/0.3.0/reference/dependencies/#citry-ext-dependencies-style) entries: its own `js` and `css`, anything in its
...
removed) rather than one component's, write an [Extension](/v/0.3.0/reference/extensions/#citry-extension) with
an `on_dependencies` method instead. See [Extensions](/v/0.3.0/advanced/extensions/).

## Where to go next

- [Error boundaries](/v/0.3.0/concepts/error-boundaries/) for the built-in, no-code way
  to catch render errors.
- [Rendering](/v/0.3.0/concepts/rendering/) for the compose, render, and serialize model
  that `on_render` plugs into.
- [JS and CSS dependencies](/v/0.3.0/advanced/js-and-css-dependencies/) for how the
  [Script](/v/0.3.0/reference/dependencies/#citry-ext-dependencies-script) and [Style](/v/0.3.0/reference/dependencies/#citry-ext-dependencies-style) entries are collected and
  placed.
- [Extensions](/v/0.3.0/advanced/extensions/) for hooks that run across the whole app.