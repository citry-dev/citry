...
url: https://citry.dev/v/0.3.0/advanced/testing/
...
a component returns a [`CitryElement`](/v/0.3.0/reference/rendering/#citry-citryelement), and `str()` on it
produces the final HTML (see [Rendering](/v/0.3.0/concepts/rendering/)), so a test can
...
itself (see [Registration](/v/0.3.0/concepts/registration/)) with a
[`Citry`](/v/0.3.0/reference/citry/#citry-citry) instance when the class is defined, and by default that
is the shared default instance ([`citry`](/v/0.3.0/reference/citry/#citry-citry-2)). Define throwaway
...
`Card` clash with an [`AlreadyRegistered`](/v/0.3.0/reference/citry/#citry-alreadyregistered) error. Give
each test its own [`Citry`](/v/0.3.0/reference/citry/#citry-citry) instance and the problem goes away.

## Give each test its own Citry instance

Construct a fresh [`Citry`](/v/0.3.0/reference/citry/#citry-citry) inside the test and point the component
...
[`CitryElement`](/v/0.3.0/reference/rendering/#citry-citryelement); `str()` renders it and serializes the
...
passing an `id_generator` to [`Citry`](/v/0.3.0/reference/citry/#citry-citry), and strip the template's
...
[Typing and validation](/v/0.3.0/concepts/typing-and-validation/)), so asserting that a
...
[`Citry`](/v/0.3.0/reference/citry/#citry-citry) per test, directly or through a fixture. A single
