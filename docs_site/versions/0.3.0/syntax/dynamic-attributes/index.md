...
url: https://citry.dev/v/0.3.0/syntax/dynamic-attributes/
...
[Expressions](/v/0.3.0/syntax/expressions/)) and strips exactly one leading `c-` from
the rendered name.
...
shorthands `c-else` and `c-empty` (see [Control flow](/v/0.3.0/syntax/control-flow/)).
...
[normalize_style](/v/0.3.0/reference/attributes/#citry-normalize-style),
[parse_string_style](/v/0.3.0/reference/attributes/#citry-parse-string-style),
[merge_attrs](/v/0.3.0/reference/attributes/#citry-merge-attrs), and [format_attrs](/v/0.3.0/reference/attributes/#citry-format-attrs).
...
See [HTML attributes](/v/0.3.0/concepts/html-attributes/) for how these fit into
