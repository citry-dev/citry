...
url: https://citry.dev/v/0.3.0/syntax/nested-templates/
...
[Dynamic attributes](/v/0.3.0/syntax/dynamic-attributes/). But sometimes you want to
...
[Comments](/v/0.3.0/syntax/comments/) for where each comment kind applies.
...
[Components](/v/0.3.0/concepts/components/) and [Slots](/v/0.3.0/concepts/slots/).