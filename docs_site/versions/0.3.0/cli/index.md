---
title: Command line
url: https://citry.dev/v/0.3.0/cli/
...
[Your first component](/v/0.3.0/getting-started/your-first-component/)), with a
[citry.Component](/v/0.3.0/reference/component/#citry-component) subclass, a `Kwargs` typed input class, a
...
([citry.citry](/v/0.3.0/reference/citry/#citry-citry-2)). To run against an engine you constructed
...
- `--app` is recognized only as the very first argument (`--app VALUE` or
  ...
  and errors out.
- The target must be a [citry.Citry](/v/0.3.0/reference/citry/#citry-citry) *instance*, not the class.
...
[citry.ComponentCatalog](/v/0.3.0/reference/component-introspection/#citry-componentcatalog) as compact JSON:
...
A command is a [citry.ExtensionCommand](/v/0.3.0/reference/extensions/#citry-extensioncommand) subclass listed
in your extension's `commands`. Declare its arguments as
[citry.CommandArg](/v/0.3.0/reference/extensions/#citry-commandarg) values and define `handle`, which receives
