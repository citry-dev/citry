...
url: https://citry.dev/v/0.3.0/concepts/client-interactivity/
...
deployment, see [Alpine runtime](/v/0.3.0/advanced/alpine-runtime/).

## Initialize a component once per live render

Define client behavior with `Component.js` and
[`$component`](/v/0.3.0/reference/browser-apis/#component). Citry registers the callback once per component
...
See [Slots](/v/0.3.0/concepts/slots/) for the server-side API.
...
see the [rootless deployment checklist](/v/0.3.0/advanced/alpine-runtime/#preserve-client-graph-markers).
...
- [Event bindings](/v/0.3.0/events/bindings/) for `@c-*`, State bindings, loading, and
  errors.
- [Event actions](/v/0.3.0/events/actions/) for rendered updates and browser actions.
- [Direct event routes](/v/0.3.0/events/http/) for server-handler security.
- [Alpine runtime](/v/0.3.0/advanced/alpine-runtime/) for plugins, CSP, loading, and deployment.
- [HTML attributes](/v/0.3.0/concepts/html-attributes/) for Python-side attribute merging.
- [HTML fragments](/v/0.3.0/advanced/html-fragments/) for client graph adoption.
- [Troubleshooting](/v/0.3.0/guides/troubleshooting/) for browser diagnostic fixes.