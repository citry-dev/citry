...
url: https://citry.dev/v/0.3.0/concepts/registration/
...
[Components](/v/0.3.0/concepts/components/).

## A component registers itself

A citry component is a subclass of [`Component`](/v/0.3.0/reference/component/#citry-component). Defining the
...
raises [`NotRegistered`](/v/0.3.0/reference/citry/#citry-notregistered). If two components would register
under the same name, the second class definition raises
[`AlreadyRegistered`](/v/0.3.0/reference/citry/#citry-alreadyregistered), so a clash fails right away
instead of quietly shadowing one component with another.

## The default engine and your own

Every component is bound to one [`Citry`](/v/0.3.0/reference/citry/#citry-citry) instance. When a
...
[`citry`](/v/0.3.0/reference/citry/#citry-citry-2). A component that does not set `citry` registers there,
which is why the examples above just work.

To group components on their own engine, construct a [`Citry`](/v/0.3.0/reference/citry/#citry-citry) and
...
[extensions](/v/0.3.0/advanced/extensions/) to itself, which makes it useful for
[tests](/v/0.3.0/advanced/testing/). A component class keeps the engine chosen when its
...
[Component libraries](/v/0.3.0/advanced/share-components/).
...
- **Absolute paths.** [`Citry`](/v/0.3.0/reference/citry/#citry-citry) rejects a relative path at
...
- The default engine is created with no `dirs`, so it never scans anything on
  its own. Autodiscovery matters once you build a [`Citry`](/v/0.3.0/reference/citry/#citry-citry) with
  `dirs`.
...
[`CitryLifecycleInProgress`](/v/0.3.0/reference/citry/#citry-citrylifecycleinprogress) promptly. It never
...
to a different [`Citry`](/v/0.3.0/reference/citry/#citry-citry) instance. A component module also cannot
