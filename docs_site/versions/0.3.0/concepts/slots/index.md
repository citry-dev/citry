---
title: Slots
url: https://citry.dev/v/0.3.0/concepts/slots/
...
[Add flexible content](/v/0.3.0/getting-started/add-slots/). This page covers the whole
...
receiver's scope. See [Client interactivity](/v/0.3.0/concepts/client-interactivity/#understand-slot-scope).
...
constructor with `slots=`. Values normalize to a [Slot](/v/0.3.0/reference/slots/#citry-slot); a plain
...
[`SlotData`](/v/0.3.0/reference/slots/#citry-slotdata) record, so identifier keys use attribute access:
...
with [SlotInput](/v/0.3.0/reference/slots/#citry-slotinput). Citry turns `Slots` into a dataclass when
...
[Typing and validation](/v/0.3.0/concepts/typing-and-validation/).

## Slot content as a value: the Slot type

Under the hood every form of slot content normalizes to a [Slot](/v/0.3.0/reference/slots/#citry-slot):
...
`Slot` is called. A `SafeString`, a [CitryElement](/v/0.3.0/reference/rendering/#citry-citryelement), or a
[CitryRender](/v/0.3.0/reference/rendering/#citry-citryrender) is trusted and never escaped.

## Slot metadata for extensions

Every [Slot](/v/0.3.0/reference/slots/#citry-slot) carries a few fields that record where its content
...
its content. Set it when you build the [Slot](/v/0.3.0/reference/slots/#citry-slot), or write to it later:
...
- [Provide and inject](/v/0.3.0/concepts/provide-and-inject/) for passing data down
  without threading it through every slot.
- [Rendering](/v/0.3.0/concepts/rendering/) for how a component tree turns into HTML.
- [Components](/v/0.3.0/concepts/components/) for the full component model.