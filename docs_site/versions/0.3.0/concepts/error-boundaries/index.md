...
url: https://citry.dev/v/0.3.0/concepts/error-boundaries/
...
- The tag is `<c-error-fallback>` (kebab-case). The name `error-fallback` is
  reserved, so registering your own [Component](/v/0.3.0/reference/component/#citry-component) under it raises
  [AlreadyRegistered](/v/0.3.0/reference/citry/#citry-alreadyregistered).
...
[Rendering](/v/0.3.0/concepts/rendering/) and with [Slots](/v/0.3.0/concepts/slots/), since the
