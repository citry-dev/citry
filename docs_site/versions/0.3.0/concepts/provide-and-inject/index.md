...
url: https://citry.dev/v/0.3.0/concepts/provide-and-inject/
...
to whatever fills that slot. See [Slots](/v/0.3.0/concepts/slots/) for how slot content
is rendered.

## Provide and inject in client code

Client components use the same three operations in
[`$component`](/v/0.3.0/reference/browser-apis/#component) setup:
...
Alpine expressions use the corresponding [`$provide`](/v/0.3.0/reference/browser-apis/#provide),
[`$inject`](/v/0.3.0/reference/browser-apis/#inject), and [`$unprovide`](/v/0.3.0/reference/browser-apis/#unprovide) magics. Establish values
...
as shown above. See [Slots](/v/0.3.0/concepts/slots/) for that difference.
...
[Dynamic attributes](/v/0.3.0/syntax/dynamic-attributes/) for that syntax, and `c-bind`
...
The [Component](/v/0.3.0/reference/component/#citry-component) `provide`, `inject`, and `unprovide` methods,
