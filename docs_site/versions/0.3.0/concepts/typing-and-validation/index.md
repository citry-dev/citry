...
url: https://citry.dev/v/0.3.0/concepts/typing-and-validation/
...
Add a `class Kwargs:` to your [Component](/v/0.3.0/reference/component/#citry-component) and list each prop
...
See [Slots](/v/0.3.0/concepts/slots/) for how to fill and default slot content.
...
fit together more broadly, see [Components](/v/0.3.0/concepts/components/) and
[Use data in components](/v/0.3.0/getting-started/data-in-components/).
...
See [JS and CSS dependencies](/v/0.3.0/advanced/js-and-css-dependencies/) for how a component
...
name. See [Subclassing](/v/0.3.0/concepts/subclassing/) for more on extending components.