---
title: Progress
url: https://citry.dev/v/0.4.1/ui-library/components/progress/
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/determinate/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/indeterminate/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/custom-range/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/intents/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/sizes-and-shapes/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/busy-region/)
...
[Open the rendered preview](/v/0.4.1/ui-library/components/progress/_previews/customization/)
