...
url: https://citry.dev/v/0.4.1/advanced/custom-component-values/
...
[`ComponentLike`](/v/0.4.1/reference/component-libraries/#citry-componentlike) protocol lets that object become a Citry
...
The method must return a [`CitryElement`](/v/0.4.1/reference/rendering/#citry-citryelement) that belongs to
...
[`LibraryComponentInvocation`](/v/0.4.1/reference/component-libraries/#citry-librarycomponentinvocation) implements
the same protocol and adds `render(citry=app)` for that library-specific use
case. See [Component libraries](/v/0.4.1/advanced/component-libraries/).

## Related reference

- [`ComponentLike`](/v/0.4.1/reference/component-libraries/#citry-componentlike)
- [`CitryElement`](/v/0.4.1/reference/rendering/#citry-citryelement)
- [`Citry.get()`](/v/0.4.1/reference/citry/#citry-citry-get)