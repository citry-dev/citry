...
url: https://citry.dev/v/0.4.1/advanced/const-optimization/
description: "Mark stable component inputs so Citry can reuse the template work that depends on them."
---
# Const optimization

Use [`Const`](/v/0.4.1/reference/rendering/#citry-const) when the same component input appears across many
...
[`is_const`](/v/0.4.1/reference/rendering/#citry-is-const) to detect the marker and
[`const_value`](/v/0.4.1/reference/rendering/#citry-const-value) to retrieve its value:
...
[`Citry`](/v/0.4.1/reference/citry/#citry-citry) instance. [`Citry.clear`](/v/0.4.1/reference/citry/#citry-citry-clear) empties it.
...
- [Cache rendered output](/v/0.4.1/advanced/caching/) for reusing a complete rendered
  subtree.
- [Rendering](/v/0.4.1/concepts/rendering/) for the full render and serialization
  process.