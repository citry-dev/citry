...
url: https://citry.dev/v/0.4.1/advanced/dynamic-components/
...
[`Kwargs`](/v/0.4.1/reference/component/#citry-component-kwargs) and
[`Slots`](/v/0.4.1/reference/component/#citry-component-slots) declarations as usual.

Browser-side bindings follow the usual component-boundary rules. They do not
become Python kwargs. See
[Client interactivity](/v/0.4.1/concepts/client-interactivity/) for `$c-props`, Alpine
...
- a [`Component`](/v/0.4.1/reference/component/#citry-component) subclass, such as `Card`.
...
[`CitryElement`](/v/0.4.1/reference/rendering/#citry-citryelement) with `{{ ... }}`, or pass its class and
let `<c-component>` create it. An unknown name raises
[`NotRegistered`](/v/0.4.1/reference/citry/#citry-notregistered). Citry never treats an unknown
...
[`c-bind` mapping](/v/0.4.1/syntax/dynamic-attributes/):
...
[Provide and inject](/v/0.4.1/concepts/provide-and-inject/) continue through the
selection normally.

For choosing content without changing the whole tag, see
[Control flow](/v/0.4.1/syntax/control-flow/).