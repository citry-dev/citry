---
title: Browser APIs
url: https://citry.dev/v/0.4.1/reference/browser-apis/
...
| `data` | A fresh instance-local graph parsed from the JSON returned by [`js_data()`](/v/0.4.1/reference/component/#citry-component-js-data), or `null`. |
...
The [Client interactivity](/v/0.4.1/concepts/client-interactivity/) page explains
component boundaries, client props, slot scope, and rootless components. The
[Component JavaScript and CSS](/v/0.4.1/advanced/js-and-css-dependencies/) explains
...
`switchLocale()`. See [Browser i18n](/v/0.4.1/i18n/browser/) for `$c-tr`, dynamic
...
[Security](/v/0.4.1/security/#treat-state-as-client-input).
...
[`actions.Data`](/v/0.4.1/reference/events/#citry-ext-events-actions-data) value. A declarative `@c-*`
...
See [Provide and inject](/v/0.4.1/concepts/provide-and-inject/) for shadowing, slot
...
The Events guides cover [State](/v/0.4.1/events/state/), [template
bindings](/events/bindings/), [returned actions](/v/0.4.1/events/actions/), and
[direct HTTP routes](/v/0.4.1/events/http/). [Alpine
