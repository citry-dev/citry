...
url: https://citry.dev/v/0.4.1/guides/dev-server/
...
Installing citry gives you a `citry` command (see the [CLI reference](/v/0.4.1/cli/)).
...
Every path above ends in the same call on the [Citry](/v/0.4.1/reference/citry/#citry-citry) engine:
...
Take a [Component](/v/0.4.1/reference/component/#citry-component) whose template lives in a file:
...
[Const optimization](/v/0.4.1/advanced/const-optimization/) and
[Cache rendered output](/v/0.4.1/advanced/caching/). For loading JavaScript and CSS
from files, see [Dependency files](/v/0.4.1/advanced/dependency-files/).