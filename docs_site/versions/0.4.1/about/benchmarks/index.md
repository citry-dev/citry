---
title: Benchmarks
url: https://citry.dev/v/0.4.1/about/benchmarks/
...
<img src="/static/img/benchmark.png" alt="Citry vs Django vs django-components rendering a large page; lower is better" width="720" />
...
- [Const optimization](/v/0.4.1/advanced/const-optimization/) covers
  [`Const`](/v/0.4.1/reference/rendering/#citry-const), the
