...
url: https://citry.dev/v/0.4.1/getting-started/client-props-and-handlers/
...
Start with [Add browser behavior](/v/0.4.1/getting-started/browser-interactivity/) if
you have not used `js_data()` with Alpine in Citry yet. This chapter introduces
[`$component`](/v/0.4.1/reference/browser-apis/#component) because the child needs to declare reactive client
...
### Reactive parent and child components
...
[`ChoiceButton.js`](/v/0.4.1/reference/component/#citry-component-js) declares one browser prop called
`label`:
...
The [Client interactivity](/v/0.4.1/concepts/client-interactivity/) guide covers
