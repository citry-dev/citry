---
title: Event actions
url: https://citry.dev/v/0.4.1/events/actions/
...
[`actions.Render`](/v/0.4.1/reference/events/#citry-ext-events-actions-render) places a rendered component
...
[`actions.Dispatch`](/v/0.4.1/reference/events/#citry-ext-events-actions-dispatch) sends its browser
...
| [`$onEvent(name, fn)`](/v/0.4.1/reference/browser-apis/#on-event) | Only events targeting this component instance. |
| `$component`'s `onEvent(name, fn)` | The same instance-scoped events, with component cleanup. |
| [`Citry.events.on(name, fn)`](/v/0.4.1/reference/browser-apis/#citry-events-on) | Matching events from every instance, plus instance-less events. |
...
member provided to [`$component`](/v/0.4.1/reference/browser-apis/#component) ties the subscription to that
...
| [`actions.Render(...)`](/v/0.4.1/reference/events/#citry-ext-events-actions-render) | Render into an explicit target with the selected swap. |
| `dict` or [`actions.Data(value)`](/v/0.4.1/reference/events/#citry-ext-events-actions-data) | Resolve an imperative caller's Promise with JSON data. |
| [`actions.Dispatch(name, detail)`](/v/0.4.1/reference/events/#citry-ext-events-actions-dispatch) | Dispatch a bubbling browser `CustomEvent`. |
| [`actions.Redirect(url)`](/v/0.4.1/reference/events/#citry-ext-events-actions-redirect) | Navigate the page. |
| [`actions.PushUrl(url)`](/v/0.4.1/reference/events/#citry-ext-events-actions-pushurl) | Add a browser history entry without navigating. |
| [`actions.ReplaceUrl(url)`](/v/0.4.1/reference/events/#citry-ext-events-actions-replaceurl) | Replace the current browser history URL without navigating. |
| [`actions.Download(...)`](/v/0.4.1/reference/events/#citry-ext-events-actions-download) | Download a file by itself. See [dedicated download responses](/v/0.4.1/events/http/#download-a-file-from-one-event). |
| `None` | Acknowledge the call without a visible action. |

### Choose Data or Dispatch for browser code

[`actions.Data`](/v/0.4.1/reference/events/#citry-ext-events-actions-data) is a one-call return value.
...
[`actions.Dispatch`](/v/0.4.1/reference/events/#citry-ext-events-actions-dispatch) when browser code must
...
[Template flags](/v/0.4.1/syntax/dynamic-attributes/#c-template-flags).
