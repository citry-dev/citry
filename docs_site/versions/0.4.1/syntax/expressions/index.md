---
title: Expressions
url: https://citry.dev/v/0.4.1/syntax/expressions/
...
[Dynamic attributes](/v/0.4.1/syntax/dynamic-attributes/) use the same expressions,
...
By default, every field in a component's [`Kwargs`](/v/0.4.1/reference/component/#citry-component-kwargs)
...
Use [`template_data`](/v/0.4.1/reference/component/#citry-component-template-data) when the template needs a
...
| Composed components <br/> ([`Component()`](/v/0.4.1/reference/component/#citry-component), [`CitryElement`](/v/0.4.1/reference/rendering/#citry-citryelement)) | Behaves as part of template |
| Rendered components <br/> ([`Component().render()`](/v/0.4.1/reference/rendering/#citry-citryelement-render), [`CitryRender`](/v/0.4.1/reference/rendering/#citry-citryrender)) | Behaves as part of template |
| [`Slot`](/v/0.4.1/reference/slots/#citry-slot) | Behaves as part of template |
| [`Markup`](/v/0.4.1/reference/rendering/#citry-markup) or an object with `__html__()` | Inserted as trusted HTML |
...
[`Markup`](/v/0.4.1/reference/rendering/#citry-markup) and `__html__()` bypass the escaping that
...
See [Comments and literal text](/v/0.4.1/syntax/comments/).
...
A blocked operation raises [`SecurityError`](/v/0.4.1/reference/rendering/#citry-securityerror).

Read [Security](/v/0.4.1/security/) for the complete sandbox contract and the settings
that control it.