...
url: https://citry.dev/v/0.4.1/syntax/comments/
...
[Conditions and loops](/v/0.4.1/syntax/control-flow/#wrap-several-elements-in-a-condition)
for the exact rule.
...
[Markup in attributes](/v/0.4.1/syntax/nested-templates/#when-the-fragment-markers-are-optional).