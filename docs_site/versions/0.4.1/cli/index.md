---
title: Command line
url: https://citry.dev/v/0.4.1/cli/
...
[`Component`](/v/0.4.1/reference/component/#citry-component) with `Kwargs`, `Slots`, and an inline template.
...
[`citry`](/v/0.4.1/reference/citry/#citry-citry-2) engine by default. `check` requires one of the explicit
...
The target must be an imported [`Citry`](/v/0.4.1/reference/citry/#citry-citry) instance. `--app` must be
...
application's [template lint policy](/v/0.4.1/ide/template-linting/) to free root
...
[component discovery](/v/0.4.1/advanced/component-discovery/) found a module.

## Export the runtime catalog

`inspect --json` prints the versioned
[`ComponentCatalog`](/v/0.4.1/reference/component-introspection/#citry-componentcatalog) as compact JSON:
...
Call [`inspect_components()`](/v/0.4.1/reference/citry/#citry-citry-inspect-components) from Python when
...
[Hot reload](/v/0.4.1/guides/dev-server/) for the complete development setup.
...
Define an [`ExtensionCommand`](/v/0.4.1/reference/extensions/#citry-extensioncommand), describe its arguments
with [`CommandArg`](/v/0.4.1/reference/extensions/#citry-commandarg), and list it on the extension:
...
See [Extensions](/v/0.4.1/advanced/extensions/) for the rest of the extension API.

## Related reference

- [`Citry.inspect_components()`](/v/0.4.1/reference/citry/#citry-citry-inspect-components)
- [`ComponentCatalog`](/v/0.4.1/reference/component-introspection/#citry-componentcatalog)
- [`ExtensionCommand`](/v/0.4.1/reference/extensions/#citry-extensioncommand)
- [`CommandArg`](/v/0.4.1/reference/extensions/#citry-commandarg)
- [`CommandArgGroup`](/v/0.4.1/reference/extensions/#citry-commandarggroup)