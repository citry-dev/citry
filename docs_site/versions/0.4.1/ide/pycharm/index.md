---
title: PyCharm
url: https://citry.dev/v/0.4.1/ide/pycharm/
...
Change `app` to the `module:attribute` path of the project's [`Citry`](/v/0.4.1/reference/citry/#citry-citry)
instance or [`ComponentLibrary`](/v/0.4.1/reference/component-libraries/#citry-componentlibrary). For example:
...
Use registry mode when the project can import its [`Citry`](/v/0.4.1/reference/citry/#citry-citry)
instance:
