...
url: https://citry.dev/v/0.5.1/syntax/control-flow/
...
Read [Expressions](/v/0.5.1/syntax/expressions/) for the Python you can use in a
condition or loop clause. Read [Attributes](/v/0.5.1/syntax/dynamic-attributes/) for
