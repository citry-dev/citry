---
title: IDE support
url: https://citry.dev/v/0.5.1/ide/
...
Start with [VS Code](/v/0.5.1/ide/vscode/) for the complete editor integration. See
[PyCharm](/v/0.5.1/ide/pycharm/) for the tested LSP4IJ setup and its current coloring
...
[`Citry`](/v/0.5.1/reference/citry/#citry-citry) instance used by the application:
...
application as described in [Template linting](/v/0.5.1/ide/template-linting/).