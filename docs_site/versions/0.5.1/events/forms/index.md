...
url: https://citry.dev/v/0.5.1/events/forms/
...
Start with [Server events](/v/0.5.1/events/) if you have not called a Python handler
...
Raise [`EventError`](/v/0.5.1/reference/events/#citry-ext-events-eventerror) to return a human message and
...
[`$error('submit')`](/v/0.5.1/reference/browser-apis/#error) exposes this handler's retained error. Its
...
[`$loading('submit')`](/v/0.5.1/reference/browser-apis/#loading) covers this handler's time waiting in the
...
The [event bindings guide](/v/0.5.1/events/bindings/) covers submit modifiers and the
other loading and error helpers. [Use event routes directly](/v/0.5.1/events/http/)
