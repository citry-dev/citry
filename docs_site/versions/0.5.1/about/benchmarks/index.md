---
title: Benchmarks
url: https://citry.dev/v/0.5.1/about/benchmarks/
...
[performance optimization guide](/v/0.5.1/advanced/performance/).
...
[simple components](/v/0.5.1/advanced/simple-components/). Their data callbacks stay
...
- [Performance](/v/0.5.1/advanced/performance/) compares simple rendering, `Const`
  and pure component bodies.
- [Simple components](/v/0.5.1/advanced/simple-components/) explains the opt-in
