---
title: Textarea
url: https://citry.dev/v/0.5.1/ui-library/components/textarea/
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/compose-textarea/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/rows-and-resize/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/variants/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/sizes/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/field-states/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/validation-and-forms/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/controlled-values/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/native-text/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/direction-and-content/)
...
[Open the rendered preview](/v/0.5.1/ui-library/components/textarea/_previews/theme-customization/)
...
| <span id="textarea-input-ctextarea-server-inputs-rows"></span>`rows` | `positive int | ASCII decimal str` | `4` | Sets the initial visible line count. |
| <span id="textarea-input-ctextarea-server-inputs-cols"></span>`cols` | `positive int | ASCII decimal str | None` | `None` | Sets the native preferred character width and is required by hard wrapping; CSS still owns rendered inline size. |
