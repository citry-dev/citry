...
url: https://citry.dev/v/0.5.1/guides/htmx/
...
If you are starting a new Citry application, try [Citry Events](/v/0.5.1/events/)
...
[HTML fragments](/v/0.5.1/advanced/html-fragments/) for the serialization contract.