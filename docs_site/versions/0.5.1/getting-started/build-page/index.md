...
url: https://citry.dev/v/0.5.1/getting-started/build-page/
...
[Registration](/v/0.5.1/concepts/registration/) for tag names and engine ownership,
then
[Component discovery](/v/0.5.1/advanced/component-discovery/) for automatic imports
and startup.
...
[Testing components](/v/0.5.1/advanced/testing/) shows how to turn checks like this
