...
url: https://citry.dev/v/0.5.1/concepts/client-interactivity/
...
see [Alpine in components](/v/0.5.1/syntax/alpine/). For runtime loading, plugins, CSP,
and deployment, see [Alpine runtime](/v/0.5.1/advanced/alpine-runtime/).

## Seed the component scope from Python

Return initial browser data from
[`Component.js_data()`](/v/0.5.1/reference/component/#citry-component-js-data). Citry makes every top-level
...
Add [`$component`](/v/0.5.1/reference/browser-apis/#component) when the component needs setup code. Citry
...
See [Slots](/v/0.5.1/concepts/slots/) for the server-rendered composition rules.
...
[client-active HTML checklist](/v/0.5.1/advanced/alpine-runtime/#preserve-client-active-html).
...
- [Event bindings](/v/0.5.1/events/bindings/) for `@c-*`, State bindings, loading, and
  errors.
- [Event actions](/v/0.5.1/events/actions/) for server responses and browser actions.
- [Browser APIs](/v/0.5.1/reference/browser-apis/) for the exact helper contracts.
- [HTML fragments](/v/0.5.1/advanced/html-fragments/) for live HTML updates.
- [Troubleshooting](/v/0.5.1/guides/troubleshooting/) for browser diagnostic fixes.