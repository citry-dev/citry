...
url: https://citry.dev/v/0.5.1/concepts/provide-and-inject/
...
[`<c-provide>`](/v/0.5.1/reference/builtins/#c-provide) wraps the part of the render
...
[`Component.inject()`](/v/0.5.1/reference/component/#citry-component-inject). Its fields are immutable and
...
Call [`Component.provide()`](/v/0.5.1/reference/component/#citry-component-provide) in a data method when
...
[`Component.unprovide()`](/v/0.5.1/reference/component/#citry-component-unprovide) makes an inherited key
...
the outer instance. The [`SlotInput`](/v/0.5.1/reference/slots/#citry-slotinput) declaration lets the
...
[`js_data()`](/v/0.5.1/reference/component/#citry-component-js-data), then provide that value during the
component's browser setup.

## Provide and inject in client code

The [`$component` hook](/v/0.5.1/reference/browser-apis/#component) receives `provide`, `inject`, and
`unprovide` helpers:
...
Alpine expressions use [`$provide`](/v/0.5.1/reference/browser-apis/#provide), [`$inject`](/v/0.5.1/reference/browser-apis/#inject), and
[`$unprovide`](/v/0.5.1/reference/browser-apis/#unprovide):
...
- [Slots](/v/0.5.1/concepts/slots/) explains how fills keep the surrounding template's
...
- [Browser APIs](/v/0.5.1/reference/browser-apis/) lists the exact client helper and
