...
url: https://citry.dev/v/0.5.1/advanced/testing/
...
Create a fresh [`Citry`](/v/0.5.1/reference/citry/#citry-citry) instance instead:
...
[Events](/v/0.5.1/events/) and [Web frameworks](/v/0.5.1/web-frameworks/).
...
- [`Component`](/v/0.5.1/reference/component/#citry-component)
- [`CitryElement`](/v/0.5.1/reference/rendering/#citry-citryelement)
- [Rendering](/v/0.5.1/concepts/rendering/)
- [Alpine in components](/v/0.5.1/syntax/alpine/)