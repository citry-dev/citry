...
url: https://citry.dev/v/0.5.1/advanced/simple-components/
...
[`simple = True`](/v/0.5.1/reference/component/#citry-component-simple) when that component does not need
...
component contract. [`LibraryComponent`](/v/0.5.1/reference/component-libraries/#citry-librarycomponent) also accepts
...
[`pure = True`](/v/0.5.1/reference/component/#citry-component-pure) separately promises deterministic,
...
- [Performance](/v/0.5.1/advanced/performance/) compares simple rendering,
  `Const` and pure bodies.
- [Component hooks](/v/0.5.1/advanced/hooks/) covers ordinary instance behavior.
- [Benchmarks](/v/0.5.1/about/benchmarks/) describes the measured workloads.