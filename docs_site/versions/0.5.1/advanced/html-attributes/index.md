...
url: https://citry.dev/v/0.5.1/advanced/html-attributes/
...
[`c-bind`](/v/0.5.1/syntax/dynamic-attributes/#c-bind-spread) applies
...
[`merge_attrs()`](/v/0.5.1/reference/attributes/#citry-merge-attrs) keeps the last ordinary value for each
...
[`normalize_class()`](/v/0.5.1/reference/attributes/#citry-normalize-class) accepts a string, a mapping, or a
...
[`normalize_style()`](/v/0.5.1/reference/attributes/#citry-normalize-style) accepts CSS text, a mapping, or a
...
[`parse_string_style()`](/v/0.5.1/reference/attributes/#citry-parse-string-style) turns inline CSS into a
...
[`format_attrs()`](/v/0.5.1/reference/attributes/#citry-format-attrs) formats a mapping as an escaped HTML
attribute string:
...
Read
[Client interactivity](/v/0.5.1/concepts/client-interactivity/#pass-arbitrary-html-attributes-explicitly)
for the component-boundary rules, and
[Attributes](/v/0.5.1/syntax/dynamic-attributes/) for static, dynamic, and spread
values in templates.