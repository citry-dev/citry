...
url: https://citry.dev/v/0.5.1/i18n/workflow/
...
Set the application policy with [`LintSettings`](/v/0.5.1/reference/citry/#citry-lintsettings):
...
[Production and deployment](/v/0.5.1/i18n/production/) for the package requirements.
...
See [VS Code](/v/0.5.1/ide/vscode/) for project setup and the boundary between
