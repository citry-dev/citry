---
title: PyCharm
url: https://citry.dev/v/0.4.2/ide/pycharm/
...
1. Download or copy Citry's
   [LSP4IJ template directory](https://github.com/citry-dev/citry/tree/main/packages/editors/jetbrains/lsp4ij/citry){: target="_blank" rel="noopener"}.
...
Change `app` to the `module:attribute` path of the project's [`Citry`](/v/0.4.2/reference/citry/#citry-citry)
instance or [`ComponentLibrary`](/v/0.4.2/reference/component-libraries/#citry-componentlibrary). For example:
...
Use registry mode when the project can import its [`Citry`](/v/0.4.2/reference/citry/#citry-citry)
instance:
