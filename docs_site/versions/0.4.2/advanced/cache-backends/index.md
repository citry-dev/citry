...
url: https://citry.dev/v/0.4.2/advanced/cache-backends/
...
| --- | --- | --- |
| [`InMemoryCache`](/v/0.4.2/reference/citry/#citry-inmemorycache) | One process | Local development or one worker |
...
Every [`Citry`](/v/0.4.2/reference/citry/#citry-citry) instance gets a fresh in-process backend unless
...
[HTML fragments](/v/0.4.2/advanced/html-fragments/), because the browser's asset
...
The [`CitryCache`](/v/0.4.2/reference/citry/#citry-citrycache) protocol has four synchronous methods:
...
[`Citry.clear`](/v/0.4.2/reference/citry/#citry-citry-clear) clears an in-process backend and advances
...
[Cache rendered output](/v/0.4.2/advanced/caching/#change-or-remove-entries).

## See also

- [Cache rendered output](/v/0.4.2/advanced/caching/) for variations, expiry, and
  privacy requirements.
- [HTML fragments](/v/0.4.2/advanced/html-fragments/) for the multi-worker asset
  delivery case.
- [Events state](/v/0.4.2/events/state/) for server-held component state.