...
url: https://citry.dev/v/0.4.2/concepts/inputs-and-validation/
...
Add [`Kwargs`](/v/0.4.2/reference/component/#citry-component-kwargs) to a
[`Component`](/v/0.4.2/reference/component/#citry-component) and list each accepted name:
...
[`template_data()`](/v/0.4.2/reference/component/#citry-component-template-data) exposes both fields to
...
Use [`Slots`](/v/0.4.2/reference/component/#citry-component-slots) for places where someone can insert
content. Annotate each field with [`SlotInput`](/v/0.4.2/reference/slots/#citry-slotinput):
...
attribute on `<c-slot>`, are in [Slots](/v/0.4.2/concepts/slots/).
...
- [`TemplateData`](/v/0.4.2/reference/component/#citry-component-templatedata) checks
  `template_data()`;
- [`JsData`](/v/0.4.2/reference/component/#citry-component-jsdata) checks
  [`js_data()`](/v/0.4.2/reference/component/#citry-component-js-data); and
- [`CssData`](/v/0.4.2/reference/component/#citry-component-cssdata) checks
  [`css_data()`](/v/0.4.2/reference/component/#citry-component-css-data).
...
component's [`$component()`](/v/0.4.2/reference/browser-apis/#component) callback when one exists. A component
...
[Component JavaScript and CSS](/v/0.4.2/advanced/js-and-css-dependencies/) for delivery
...
[Subclassing](/v/0.4.2/advanced/subclassing/) for how schemas, templates, JavaScript,
