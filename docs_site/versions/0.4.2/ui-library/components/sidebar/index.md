---
title: Sidebar
url: https://citry.dev/v/0.4.2/ui-library/components/sidebar/
...
[Open the rendered preview](/v/0.4.2/ui-library/components/sidebar/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/sidebar/_previews/navigation/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/sidebar/_previews/collapse-modes/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/sidebar/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/sidebar/_previews/presentation/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/sidebar/_previews/customization/)
...
| <span id="sidebar-selector-csidebar-selectors-panel"></span>`[data-citry-ui-part="panel"]` | Owned div | Visibility inertness and fixed/scroll region owner. |
