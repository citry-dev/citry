---
title: Virtual List
url: https://citry.dev/v/0.4.2/ui-library/components/virtual-list/
...
[Open the rendered preview](/v/0.4.2/ui-library/components/virtual-list/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/virtual-list/_previews/windowed/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/virtual-list/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/virtual-list/_previews/accessibility/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/virtual-list/_previews/customization/)
...
| <span id="virtual-list-input-cvirtual-list-server-inputs-focusable"></span>`focusable` | `bool` | `True` | Adds or removes the root tabindex=0 keyboard-scroll stop. |
...
| <span id="virtual-list-input-cvirtual-window-server-inputs-focusable"></span>`focusable` | `bool` | `True` | Adds or removes the root tabindex=0 keyboard-scroll stop. |
