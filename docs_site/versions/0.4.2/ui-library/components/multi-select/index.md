---
title: MultiSelect
url: https://citry.dev/v/0.4.2/ui-library/components/multi-select/
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/forms/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/groups/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/states/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/close-on-select/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/variants/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/keyboard/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/multi-select/_previews/customization/)
