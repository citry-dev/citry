---
title: Tour
url: https://citry.dev/v/0.4.2/ui-library/components/tour/
...
[Open the rendered preview](/v/0.4.2/ui-library/components/tour/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/tour/_previews/targeted/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/tour/_previews/centered/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/tour/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/tour/_previews/missing-targets/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/tour/_previews/customization/)
...
| <span id="tour-input-ctour-server-inputs-attrs"></span>`attrs` | `Mapping[str, object] | None` | `None` | Adds copied allowed host attributes without replacing owned modal state identity or behavior. |
...
|---|---|---|---|
| <span id="tour-input-ctour-client-inputs-open"></span>`open` | `boolean | null` | Releases control to the committed value. | Controls modal visibility independently from active step. |
...
|---|---|---|---|
| <span id="tour-css-ctour-css-variables-width"></span>`--cui-tour-width` | `length` | Card inline size overriding the selected profile. | `sm 20rem; md 24rem; lg 30rem` |
...
| <span id="tour-css-ctour-css-variables-shadow"></span>`--cui-tour-shadow` | `shadow` | Card elevation. | `Modal elevation` |
...
|---|---|---|---|
| <span id="tour-attribute-ctour-attributes-data-open"></span>`data-open` | Tour host and dialog | `present | absent` | Marks effective modal visibility. |
...
| <span id="tour-selector-ctour-selectors-dialog"></span>`[data-citry-ui-part="dialog"]` | Native dialog | Modal top-layer owner. |
| <span id="tour-selector-ctour-selectors-spotlight"></span>`[data-citry-ui-part="spotlight"]` | Decorative div | Target geometry and mask cutout. |
