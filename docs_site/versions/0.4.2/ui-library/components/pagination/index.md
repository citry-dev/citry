---
title: Pagination
url: https://citry.dev/v/0.4.2/ui-library/components/pagination/
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/links/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/controlled/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/ranges/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/controls/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/presentation/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/pagination/_previews/customization/)
...
| <span id="pagination-translation-cpagination-translations-page"></span>`citry-ui-pagination-page` | Names each numbered page control. | `page: str` | `page_label` input | $c-tr handles server controls; `i18n.bind()` handles recreated controls. |
