---
title: Icon
url: https://citry.dev/v/0.4.2/ui-library/components/icon/
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/catalog/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/size-and-color/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/meaning/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/composition/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/direction/)
...
[Open the rendered preview](/v/0.4.2/ui-library/components/icon/_previews/customization/)
