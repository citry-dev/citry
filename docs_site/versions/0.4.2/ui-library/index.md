---
title: Citry UI
url: https://citry.dev/v/0.4.2/ui-library/
...
1. [Install and register Citry UI](/v/0.4.2/ui-library/installation/).
2. Use a component from the [Components](#components) section.
3. [Set colors, spacing, and component parts](/v/0.4.2/ui-library/theming/) for your
   application.
...
<section aria-labelledby="ui-library-actions">
  ...
  <ul>
    <li>
      ...
      <a href="/ui-library/components/slider/">Slider and RangeSlider</a> - Use CSlider to choose one value from a bounded exact-decimal scale. Use
CRangeSlider when the user chooses an ordered lower and upper value.
  ...
  <ul>
    <li>
      ...
      <a href="/ui-library/components/data-grid/">Data Grid</a> - Navigate, sort, select, and server-window tabular application data with Citry UI.
    </li><li>
  ...
  <ul>
    <li>
      ...
      <a href="/ui-library/components/tour/">Tour</a> - Build modal, target-aware product walkthroughs with Citry UI.
    </li><li>
