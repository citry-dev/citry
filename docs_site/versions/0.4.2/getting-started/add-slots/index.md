...
url: https://citry.dev/v/0.4.2/getting-started/add-slots/
...
Inside `ReadingPanel`, each [`<c-slot>`](/v/0.4.2/reference/builtins/#c-slot) marks a place where another template may
put content.
...
[`Slots`](/v/0.4.2/reference/component/#citry-component-slots) gives those two places names in Python:
...
[`SlotInput`](/v/0.4.2/reference/slots/#citry-slotinput) means the fill may contain rendered HTML, text,
...
through slots. The [Slots guide](/v/0.4.2/concepts/slots/) goes further into required,
