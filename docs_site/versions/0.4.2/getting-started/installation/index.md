---
title: Install Citry
url: https://citry.dev/v/0.4.2/getting-started/installation/
...
Citry code inside Python files. Follow the [VS Code setup guide](/v/0.4.2/ide/vscode/)
...
[`Component`](/v/0.4.2/reference/component/#citry-component) base class:
...
see [Compatibility](/v/0.4.2/about/compatibility/#building-from-source) for the
platform and Rust requirements.

## Next steps

Citry is installed and ready to render HTML. Next,
[build a reusable card](/v/0.4.2/getting-started/your-first-component/) with an option,
