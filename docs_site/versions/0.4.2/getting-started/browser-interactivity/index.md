...
url: https://citry.dev/v/0.4.2/getting-started/browser-interactivity/
...
Use [`js_data()`](/v/0.4.2/reference/component/#citry-component-js-data) to pass initial values from Python
...
The [Alpine runtime](/v/0.4.2/advanced/alpine-runtime/) page covers plugins, lifecycle,
...
[Alpine in templates](/v/0.4.2/syntax/alpine/) nearby as a concise syntax guide.
