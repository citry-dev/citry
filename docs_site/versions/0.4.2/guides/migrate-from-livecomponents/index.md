...
url: https://citry.dev/v/0.4.2/guides/migrate-from-livecomponents/
...
[Events migration parity matrix](/v/0.4.2/guides/events-migration-parity/) records
...
Continue with [State](/v/0.4.2/events/state/) and [event actions](/v/0.4.2/events/actions/) for
fresh renders, and [Security](/v/0.4.2/security/) for cache, CSRF, and
