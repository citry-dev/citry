...
url: https://citry.dev/v/0.4.2/guides/migrate-from-component-view/
...
[Protect event posts from CSRF](/v/0.4.2/security/#protect-event-posts-from-csrf).
...
Continue with the [Events guides](/v/0.4.2/events/) for the full API, or use the
[Events migration parity matrix](/v/0.4.2/guides/events-migration-parity/) to
