...
url: https://citry.dev/v/0.4.2/syntax/control-flow/
...
Read [Expressions](/v/0.4.2/syntax/expressions/) for the Python you can use in a
condition or loop clause. Read [Attributes](/v/0.4.2/syntax/dynamic-attributes/) for
