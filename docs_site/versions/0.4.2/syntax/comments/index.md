...
url: https://citry.dev/v/0.4.2/syntax/comments/
...
[Conditions and loops](/v/0.4.2/syntax/control-flow/#wrap-several-elements-in-a-condition)
for the exact rule.
...
[Markup in attributes](/v/0.4.2/syntax/nested-templates/#when-the-fragment-markers-are-optional).