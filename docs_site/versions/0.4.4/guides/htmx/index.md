...
url: https://citry.dev/v/0.4.4/guides/htmx/
...
If you are starting a new Citry application, try [Citry Events](/v/0.4.4/events/)
...
The complete
[HTMX patterns demo](https://github.com/citry-dev/citry/tree/citry%400.4.4/examples/demos/htmx){: target="_blank" rel="noopener"}
...
[HTML fragments](/v/0.4.4/advanced/html-fragments/) for the serialization contract.