---
title: Benchmarks
url: https://citry.dev/v/0.4.4/about/benchmarks/
...
- [Performance](/v/0.4.4/advanced/performance/) covers opt-in reuse with
  [`Const`](/v/0.4.4/reference/rendering/#citry-const) and pure component classes.