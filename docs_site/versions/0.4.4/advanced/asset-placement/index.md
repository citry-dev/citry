...
url: https://citry.dev/v/0.4.4/advanced/asset-placement/
...
[`DepsStrategy`](/v/0.4.4/reference/rendering/#citry-depsstrategy) accepts four values:
...
- `"fragment"` describes new dependencies for insertion into a page that
  already loaded Citry. See [HTML fragments](/v/0.4.4/advanced/html-fragments/).
...
[`DepsPosition`](/v/0.4.4/reference/rendering/#citry-depsposition):
...
- [Component JavaScript and CSS](/v/0.4.4/advanced/js-and-css-dependencies/) defines
  behavior, styles, and per-render browser data owned by a component.
- [Dependency files](/v/0.4.4/advanced/dependency-files/) adds libraries and shared
  files.
- [Component hooks](/v/0.4.4/advanced/hooks/) adjusts the tags contributed by one
  component.
- [Extensions](/v/0.4.4/advanced/extensions/) can adjust the collected component
