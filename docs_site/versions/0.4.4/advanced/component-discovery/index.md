...
url: https://citry.dev/v/0.4.4/advanced/component-discovery/
...
Create one [`Citry`](/v/0.4.4/reference/citry/#citry-citry) instance in a module that every component can
import:
...
Use [`inspect_component_graph()`](/v/0.4.4/reference/citry/#citry-citry-inspect-component-graph) when a
...
them. [`ComponentGraph.to_json()`](/v/0.4.4/reference/component-graph/#citry-componentgraph-to-json) produces a
versioned local-tooling document, which may contain absolute developer-machine
paths.

## Initialize before starting worker threads

Call [`initialize()`](/v/0.4.4/reference/citry/#citry-citry-initialize) before starting worker threads.
...
[Web frameworks](/v/0.4.4/web-frameworks/) for framework-specific setup.

## Run discovery explicitly

Use [`autodiscover()`](/v/0.4.4/reference/citry/#citry-citry-autodiscover) when you want the imported
...
[`initialize()`](/v/0.4.4/reference/citry/#citry-citry-initialize) once during startup, then let request
workers use the prepared engine.

## Related reference

- [`Citry`](/v/0.4.4/reference/citry/#citry-citry)
- [`Citry.initialize()`](/v/0.4.4/reference/citry/#citry-citry-initialize)
- [`Citry.autodiscover()`](/v/0.4.4/reference/citry/#citry-citry-autodiscover)
- [`Citry.inspect_component_graph()`](/v/0.4.4/reference/citry/#citry-citry-inspect-component-graph)
- [`ComponentGraph`](/v/0.4.4/reference/component-graph/#citry-componentgraph)
- [Registration](/v/0.4.4/concepts/registration/)
- [Hot reload](/v/0.4.4/guides/dev-server/)