...
url: https://citry.dev/v/0.5.0/getting-started/client-props-and-handlers/
...
Start with [Add browser behavior](/v/0.5.0/getting-started/browser-interactivity/) if
you have not used `js_data()` with Alpine in Citry yet. This chapter introduces
[`$component`](/v/0.5.0/reference/browser-apis/#component) because the child needs to declare reactive client
...
[`ChoiceButton.js`](/v/0.5.0/reference/component/#citry-component-js) declares one browser prop called
`label`:
...
The [Client interactivity](/v/0.5.0/concepts/client-interactivity/) guide covers
