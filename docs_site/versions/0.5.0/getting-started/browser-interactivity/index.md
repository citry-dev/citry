...
url: https://citry.dev/v/0.5.0/getting-started/browser-interactivity/
...
Use [`js_data()`](/v/0.5.0/reference/component/#citry-component-js-data) to pass initial values from Python
...
The [Alpine runtime](/v/0.5.0/advanced/alpine-runtime/) page covers plugins, lifecycle,
...
[Alpine in templates](/v/0.5.0/syntax/alpine/) nearby as a concise syntax guide.
