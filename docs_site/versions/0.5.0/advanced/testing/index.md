...
url: https://citry.dev/v/0.5.0/advanced/testing/
...
Create a fresh [`Citry`](/v/0.5.0/reference/citry/#citry-citry) instance instead:
...
[Events](/v/0.5.0/events/) and [Web frameworks](/v/0.5.0/web-frameworks/).
...
- [`Component`](/v/0.5.0/reference/component/#citry-component)
- [`CitryElement`](/v/0.5.0/reference/rendering/#citry-citryelement)
- [Rendering](/v/0.5.0/concepts/rendering/)
- [Alpine in components](/v/0.5.0/syntax/alpine/)