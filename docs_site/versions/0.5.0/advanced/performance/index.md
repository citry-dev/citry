---
title: Performance
url: https://citry.dev/v/0.5.0/advanced/performance/
...
- [`simple = True`](/v/0.5.0/reference/component/#citry-component-simple) renders a presentation component
  without its own instance, hooks or browser identity.
- [`Const`](/v/0.5.0/reference/rendering/#citry-const) marks an individual value that will not change, so
...
The [Simple components](/v/0.5.0/advanced/simple-components/) guide explains the
...
Use [`Const`](/v/0.5.0/reference/rendering/#citry-const) when the same component input appears across many
...
[`is_const`](/v/0.5.0/reference/rendering/#citry-is-const) to detect the marker and
[`const_value`](/v/0.5.0/reference/rendering/#citry-const-value) to retrieve its value:
...
[`Citry`](/v/0.5.0/reference/citry/#citry-citry) instance. [`Citry.clear`](/v/0.5.0/reference/citry/#citry-citry-clear) empties it.
...
- [Cache rendered output](/v/0.5.0/advanced/caching/) for reusing a complete rendered
  subtree.
- [Rendering](/v/0.5.0/concepts/rendering/) for the full render and serialization
  process.