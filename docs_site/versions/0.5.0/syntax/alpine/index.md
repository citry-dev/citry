...
url: https://citry.dev/v/0.5.0/syntax/alpine/
...
[`$component()` callback](/v/0.5.0/advanced/js-and-css-dependencies/#add-behavior-and-styles).
...
Return per-instance browser data from [`js_data()`](/v/0.5.0/reference/component/#citry-component-js-data).
...
Add [`$component`](/v/0.5.0/reference/browser-apis/#component) only when the component also needs JavaScript
setup, managed effects, client props, or additional callback-owned scope data.
The [Add browser behavior](/v/0.5.0/getting-started/browser-interactivity/) tutorial
...
boundary, use
[`$c-props`](/v/0.5.0/concepts/client-interactivity/#pass-client-props-down).
...
Read [Alpine runtime](/v/0.5.0/advanced/alpine-runtime/#choose-the-right-kind-of-loop-or-condition)
...
The [Browser APIs reference](/v/0.5.0/reference/browser-apis/#alpine-magics) gives the
exact contract for each name. Continue to
[Client interactivity](/v/0.5.0/concepts/client-interactivity/) for component-owned
