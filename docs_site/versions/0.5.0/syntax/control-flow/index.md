...
url: https://citry.dev/v/0.5.0/syntax/control-flow/
...
Read [Expressions](/v/0.5.0/syntax/expressions/) for the Python you can use in a
condition or loop clause. Read [Attributes](/v/0.5.0/syntax/dynamic-attributes/) for
