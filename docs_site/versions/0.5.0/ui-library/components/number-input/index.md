---
title: NumberInput
url: https://citry.dev/v/0.5.0/ui-library/components/number-input/
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/basic/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/exact-decimals/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/constraints/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/controlled/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/without-controls/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/wheel/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/locales/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/forms/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/number-input/_previews/states/)
