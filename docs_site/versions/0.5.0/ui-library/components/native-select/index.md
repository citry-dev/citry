---
title: Native Select
url: https://citry.dev/v/0.5.0/ui-library/components/native-select/
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/compose-select/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/options-and-groups/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/placeholder-and-required/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/variants/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/sizes/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/field-states/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/controlled-selection/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/native-picker/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/native-select/_previews/theme-customization/)
