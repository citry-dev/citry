---
title: Button
url: https://citry.dev/v/0.5.0/ui-library/components/button/
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/basic-actions/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/navigation/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/configuration/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/variants/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/intents/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/sizes-and-layout/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/decorations/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/loading-states/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/native-forms/)
...
[Open the rendered preview](/v/0.5.0/ui-library/components/button/_previews/theme-customization/)
