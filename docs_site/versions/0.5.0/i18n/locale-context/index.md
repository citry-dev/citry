...
url: https://citry.dev/v/0.5.0/i18n/locale-context/
...
[Organize catalogs](/v/0.5.0/i18n/catalogs/) for the package layout and precedence
rules.
...
element as the subtree boundary. See [Browser i18n](/v/0.5.0/i18n/browser/).
