...
url: https://citry.dev/v/0.5.0/ide/template-linting/
...
[template variables](/v/0.5.0/ide/diagnostics/#citry.template.unknown-variable),
[Alpine variables](/v/0.5.0/ide/diagnostics/#citry.alpine.unknown-variable), and
[component JavaScript variables](/v/0.5.0/ide/diagnostics/#citry.component-js.unknown-variable)
...
Pass one [`LintSettings`](/v/0.5.0/reference/citry/#citry-lintsettings) object to [`Citry`](/v/0.5.0/reference/citry/#citry-citry):
...
[`TemplateNamespaceContribution`](/v/0.5.0/reference/extensions/#citry-templatenamespacecontribution). An
