---
title: Compatibility
url: https://citry.dev/v/0.5.0/about/compatibility/
...
[the pre-start API](/v/0.5.0/advanced/alpine-runtime/#add-an-alpine-plugin).

## See also

- [Installation](/v/0.5.0/getting-started/installation/) walks through installing citry and confirming it works.
- [Alpine runtime](/v/0.5.0/advanced/alpine-runtime/) documents browser loading and deployment.