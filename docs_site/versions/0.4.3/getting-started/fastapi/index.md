...
url: https://citry.dev/v/0.4.3/getting-started/fastapi/
...
- [FastAPI / Starlette](/v/0.4.3/web-frameworks/#fastapi-and-starlette)
- [Django](/v/0.4.3/web-frameworks/#django)
- [Flask](/v/0.4.3/web-frameworks/#flask)
- Other [ASGI or WSGI applications](/v/0.4.3/web-frameworks/#bare-asgi-and-wsgi).
...
[`Citry`](/v/0.4.3/reference/citry/#citry-citry) instance. That keeps its components, rendered pages,
and mounted browser routes together.

The secret lets Citry detect changes to data that travels through the browser.
You will use that feature when you add [`State`](/v/0.4.3/reference/component/#citry-component-state).
...
[`Component.citry`](/v/0.4.3/reference/component/#citry-component-citry) tells each class which Citry
...
[`citry_app.initialize()`](/v/0.4.3/reference/citry/#citry-citry-initialize) prepares the registered
...
[`mount(app, citry_app)`](/v/0.4.3/reference/contrib/#citry-contrib-fastapi-mount) uses `/citry` by
...
The [Web frameworks](/v/0.4.3/web-frameworks/) guide shows the matching setup for
