...
url: https://citry.dev/v/0.4.3/ui-library/installation/
...
Register the library once with the [`Citry`](/v/0.4.3/reference/citry/#citry-citry) instance that renders your
application:
...
Registration makes tags such as [`<c-CButton>`](/v/0.4.3/ui-library/components/button/) and [`<c-CTabs>`](/v/0.4.3/ui-library/components/tabs/) available to
