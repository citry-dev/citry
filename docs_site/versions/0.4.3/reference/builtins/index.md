---
title: Built-in tags
url: https://citry.dev/v/0.4.3/reference/builtins/
...
The [control-flow guide](/v/0.4.3/syntax/control-flow/) covers inline `c-if`
...
Read [Conditions and loops](/v/0.4.3/syntax/control-flow/#unpack-and-filter-values)
...
See [Slots](/v/0.4.3/concepts/slots/) for required slots, slot data, dynamic names,
...
Read [Dynamic components](/v/0.4.3/advanced/dynamic-components/) for complete examples
...
attribute.
See [Locales and context](/v/0.4.3/i18n/locale-context/) and
[Browser i18n](/v/0.4.3/i18n/browser/).
...
inline component. See [Rich messages](/v/0.4.3/i18n/rich-messages/).
...
Read [Comments and literal text](/v/0.4.3/syntax/comments/#pass-template-looking-text-through-unchanged)
