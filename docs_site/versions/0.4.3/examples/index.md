---
title: Examples
url: https://citry.dev/v/0.4.3/examples/
...
- [Card](/v/0.4.3/examples/card/) - accept an input, render content, and add CSS.
- [Slots](/v/0.4.3/examples/slots/) - offer named areas with fallback content.
- [Provide and inject](/v/0.4.3/examples/provide-inject/) - share data with a subtree.
- [Error boundary](/v/0.4.3/examples/error-fallback/) - show a safe fallback after an
  error.
- [Recursion](/v/0.4.3/examples/recursion/) - let a component render itself.

## Template syntax

- [Control flow](/v/0.4.3/examples/control-flow/) - use conditions, loops, and an empty
  state.

## Browser and server

- [Tabs](/v/0.4.3/examples/tabs/) - ship JavaScript with a component.
- [Form submission](/v/0.4.3/examples/form-submission/) - handle a form in the browser.
- [Fragments](/v/0.4.3/examples/fragments/) - load rendered HTML and its assets on
  demand.