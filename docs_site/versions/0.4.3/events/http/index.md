...
url: https://citry.dev/v/0.4.3/events/http/
...
component with [`get_event_url()`](/v/0.4.3/reference/events/#citry-ext-events-get-event-url). GET handlers
...
[`Citry.events.send`](/v/0.4.3/reference/browser-apis/#citry-events-send). The returned promise resolves with
...
[Security](/v/0.4.3/security/#protect-event-posts-from-csrf).