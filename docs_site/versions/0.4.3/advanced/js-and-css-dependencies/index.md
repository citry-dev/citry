...
url: https://citry.dev/v/0.4.3/advanced/js-and-css-dependencies/
...
files, see [Dependency files](/v/0.4.3/advanced/dependency-files/). To control where
the collected tags appear, see
[Place JavaScript and CSS](/v/0.4.3/advanced/asset-placement/).
...
[`$component()`](/v/0.4.3/reference/browser-apis/#component) registers a callback for each rendered `Chart`.
Its `els` value contains the component's root elements. Its `data` value is
what that render returned from [`js_data()`](/v/0.4.3/reference/component/#citry-component-js-data).
...
[`js_data()`](/v/0.4.3/reference/component/#citry-component-js-data) returns the data for one render. Citry
...
[`css_data()`](/v/0.4.3/reference/component/#citry-component-css-data) turns one render's values into CSS
...
[Inputs and validation](/v/0.4.3/concepts/inputs-and-validation/) for the available
schema styles.
...
- [Dependency files](/v/0.4.3/advanced/dependency-files/) adds libraries, shared
  files, tag attributes, and local-file serving.
- [Place JavaScript and CSS](/v/0.4.3/advanced/asset-placement/) controls where and
  how the collected tags are inserted.
- [Component hooks](/v/0.4.3/advanced/hooks/) adjusts the tags contributed by one
  component.
- [HTML fragments](/v/0.4.3/advanced/html-fragments/) carries new dependencies into
