...
url: https://citry.dev/v/0.4.3/advanced/component-libraries/
...
each application installs them into its own [`Citry`](/v/0.4.3/reference/citry/#citry-citry) instance.
...
Subclass [`LibraryComponent`](/v/0.4.3/reference/component-libraries/#citry-librarycomponent) instead of `Component`.
...
List the definitions in a [`ComponentLibrary`](/v/0.4.3/reference/component-libraries/#citry-componentlibrary), in the
...
[`register_library()`](/v/0.4.3/reference/citry/#citry-citry-register-library):
...
[Custom component values](/v/0.4.3/advanced/custom-component-values/).
...
[`Citry.clear()`](/v/0.4.3/reference/citry/#citry-citry-clear) or when another generation replaces it.
Accessing its classes then raises
[`LibraryInstallationStale`](/v/0.4.3/reference/component-libraries/#citry-libraryinstallationstale) instead of
returning a class that no longer belongs to the active registry.

## Related reference

- [`LibraryComponent`](/v/0.4.3/reference/component-libraries/#citry-librarycomponent)
- [`LibraryComponentInvocation`](/v/0.4.3/reference/component-libraries/#citry-librarycomponentinvocation)
- [`ComponentLibrary`](/v/0.4.3/reference/component-libraries/#citry-componentlibrary)
- [`LibraryInstallation`](/v/0.4.3/reference/component-libraries/#citry-libraryinstallation)
- [`Citry.register_library()`](/v/0.4.3/reference/citry/#citry-citry-register-library)