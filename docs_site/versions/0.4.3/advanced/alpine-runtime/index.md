...
url: https://citry.dev/v/0.4.3/advanced/alpine-runtime/
...
[`$component`](/v/0.4.3/reference/browser-apis/#component), client props, event handlers, and Events state.
The same rules apply whether you render a whole document or an
[HTML fragment](/v/0.4.3/advanced/html-fragments/).
...
Use [`Citry.alpine.beforeStart`](/v/0.4.3/reference/browser-apis/#citry-alpine-before-start) to register a plugin
...
trusted. See [Security](/v/0.4.3/security/#apply-a-request-csp-nonce-centrally) for the
complete boundary.
...
[Security](/v/0.4.3/security/#choose-how-much-javascript-citry-may-deliver) for the
...
The [Debug extension](/v/0.4.3/reference/extensions/#citry-ext-debug-debug) can draw component and slot
boundaries. [Troubleshooting](/v/0.4.3/guides/troubleshooting/) covers the wider
server and browser investigation workflow.

## See also

- [Client interactivity](/v/0.4.3/concepts/client-interactivity/) for Alpine data,
  props, handlers, and component lifecycles.
- [HTML fragments](/v/0.4.3/advanced/html-fragments/) for inserting client-active
  output into an existing page.
- [Component JavaScript and CSS](/v/0.4.3/advanced/js-and-css-dependencies/) for
  non-Alpine assets.
- [Compatibility](/v/0.4.3/about/compatibility/) for supported browsers.