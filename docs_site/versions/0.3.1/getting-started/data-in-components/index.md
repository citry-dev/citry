...
url: https://citry.dev/v/0.3.1/getting-started/data-in-components/
...
[Your first component](/v/0.3.1/getting-started/your-first-component/).
...
Use [`template_data()`](/v/0.3.1/reference/component/#citry-component-template-data) when the template needs
...
!!! note
    ...
    For a component that only needs its `Kwargs` fields, leave the `template_data()` out and Citry supplies those fields automatically. Like we did in [Your first component](/v/0.3.1/getting-started/your-first-component#create-the-card).
...
The [Control flow](/v/0.3.1/syntax/control-flow/) and [Dynamic
...
[build a complete page from components](/v/0.3.1/getting-started/build-page/)
