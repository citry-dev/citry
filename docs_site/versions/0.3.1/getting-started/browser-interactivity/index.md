...
url: https://citry.dev/v/0.3.1/getting-started/browser-interactivity/
...
`template_data()` uses [`self.id`](/v/0.3.1/reference/component/#citry-component-id) to give each rendered
...
[`js_data()`](/v/0.3.1/reference/component/#citry-component-js-data) and [`$component`](/v/0.3.1/reference/browser-apis/#component) to pass
...
The [Alpine runtime](/v/0.3.1/advanced/alpine-runtime/) page covers plugins, lifecycle,
