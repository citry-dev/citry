...
url: https://citry.dev/v/0.3.1/getting-started/add-slots/
...
[`SlotInput`](/v/0.3.1/reference/slots/#citry-slotinput) means the fill may contain rendered HTML, text,
...
through slots. The [Slots guide](/v/0.3.1/concepts/slots/) goes further into required,
