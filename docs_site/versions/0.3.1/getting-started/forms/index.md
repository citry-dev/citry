...
url: https://citry.dev/v/0.3.1/getting-started/forms/
...
[`EventError`](/v/0.3.1/reference/events/#citry-ext-events-eventerror) when the domain is wrong:
...
[`$error.message`](/v/0.3.1/reference/browser-apis/#error) if you want a message for the whole form. The
[`fields`](/v/0.3.1/reference/events/#citry-ext-events-eventerror-fields) mapping adds messages for
...
[`$loading('submit')`](/v/0.3.1/reference/browser-apis/#loading):
...
calling another service. The [Forms guide](/v/0.3.1/events/forms/) covers larger input
