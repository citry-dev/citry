...
url: https://citry.dev/v/0.3.1/getting-started/server-rendered-updates/
...
[`actions.Render`](/v/0.3.1/reference/events/#citry-ext-events-actions-render) action:
...
[`target="#signup-result"`](/v/0.3.1/reference/events/#citry-ext-events-actions-render-target) points to
that element with a CSS selector.
[`swap="inner"`](/v/0.3.1/reference/events/#citry-ext-events-actions-render-swap) replaces its contents
...
[`js_data()`](/v/0.3.1/reference/component/#citry-component-js-data):
...
The [`$component`](/v/0.3.1/reference/browser-apis/#component) callback receives that value as `data.email`:
...
[`<c-css />`](/v/0.3.1/reference/builtins/#c-css) and [`<c-js />`](/v/0.3.1/reference/builtins/#c-js) place the assets needed by
...
See [Event actions](/v/0.3.1/events/actions/) for the other results a handler can
return, and [HTML fragments](/v/0.3.1/advanced/html-fragments/) for a deeper look at
...
- use [Examples](/v/0.3.1/examples/) when you want working code for a specific task;
- read [Docs](/v/0.3.1/getting-started/installation/) when you want a concept or guided
  workflow; or
- open [Reference](/v/0.3.1/reference/) when you need the exact API for a class,
