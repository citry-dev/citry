---
title: Expressions
url: https://citry.dev/v/0.3.1/syntax/expressions/
...
[Dynamic attributes](/v/0.3.1/syntax/dynamic-attributes/) for the attribute side.
...
directly with [safe_eval](/v/0.3.1/reference/citry/#citry-citry-2) applied to a bare name:
...
comments), see [Comments](/v/0.3.1/syntax/comments/).