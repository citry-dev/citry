---
title: Control flow
url: https://citry.dev/v/0.3.1/syntax/control-flow/
...
[Expressions](/v/0.3.1/syntax/expressions/) for why the template side stays simple:
...
- [Expressions](/v/0.3.1/syntax/expressions/) for what you can write inside `cond`,
  `each`, and `{{ }}`.
- [Dynamic attributes](/v/0.3.1/syntax/dynamic-attributes/) for binding attributes
