---
title: Browser APIs
url: https://citry.dev/v/0.3.1/reference/browser-apis/
...
| `data` | The JSON value returned by [`js_data()`](/v/0.3.1/reference/component/#citry-component-js-data), or `null`. |
...
The [Client interactivity](/v/0.3.1/concepts/client-interactivity/) page explains
component boundaries, client props, slot scope, and rootless components. The
[JS and CSS dependencies](/v/0.3.1/advanced/js-and-css-dependencies/) page explains
...
[Security](/v/0.3.1/security/#treat-state-as-client-input).
...
See [Provide and inject](/v/0.3.1/concepts/provide-and-inject/) for shadowing, slot
...
The Events guides cover [State](/v/0.3.1/events/state/), [template
bindings](/events/bindings/), [returned actions](/v/0.3.1/events/actions/), and
[direct HTTP routes](/v/0.3.1/events/http/). [Alpine
