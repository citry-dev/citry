...
url: https://citry.dev/v/0.3.1/advanced/alpine-runtime/
...
Use [`Citry.alpine.beforeStart`](/v/0.3.1/reference/browser-apis/#citry-alpine-before-start) to register a plugin
before startup:
...
boundary; see [Security](/v/0.3.1/security/).

## Documents and fragments use the same graph

Any of these can activate Citry's client ownership graph:

- `Component.js` and [`$component`](/v/0.3.1/reference/browser-apis/#component);
...
The [Debug extension](/v/0.3.1/reference/extensions/#citry-ext-debug-debug) visualizes server component and
slot boundaries, while [Troubleshooting](/v/0.3.1/guides/troubleshooting/) covers
...
- [Client interactivity](/v/0.3.1/concepts/client-interactivity/) for props, handlers, scopes, and lifecycle APIs.
- [JS and CSS dependencies](/v/0.3.1/advanced/js-and-css-dependencies/) for non-Alpine assets.
- [Compatibility](/v/0.3.1/about/compatibility/) for server and browser coverage.