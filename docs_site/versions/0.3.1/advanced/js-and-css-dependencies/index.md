...
url: https://citry.dev/v/0.3.1/advanced/js-and-css-dependencies/
...
Inside the JS, [`$component(...)`](/v/0.3.1/reference/browser-apis/#component) registers a callback that citry
...
Use [`Script`](/v/0.3.1/reference/dependencies/#citry-ext-dependencies-script) or
[`Style`](/v/0.3.1/reference/dependencies/#citry-ext-dependencies-style) when an asset needs inline content or
...
`serialize` method takes a `deps_strategy` ([`DepsStrategy`](/v/0.3.1/reference/rendering/#citry-depsstrategy))
...
- `"fragment"`: emits a URL manifest for insertion into an already-loaded page.
  See [HTML fragments](/v/0.3.1/advanced/html-fragments/).
- `"ignore"`: inserts no dependency tags at all.

A `deps_position` ([`DepsPosition`](/v/0.3.1/reference/rendering/#citry-depsposition)) of `"smart"` (the
...
citry gives you the final say over them. Each asset is a [`Script`](/v/0.3.1/reference/dependencies/#citry-ext-dependencies-script)
or [`Style`](/v/0.3.1/reference/dependencies/#citry-ext-dependencies-style) object holding either inline `content` or a `url`, plus
...
`on_dependencies` method on an [Extension](/v/0.3.1/reference/extensions/#citry-extension). It receives an
...
See [Extensions](/v/0.3.1/advanced/extensions/) for how extensions are written and
installed.
...
When you build a [`Script`](/v/0.3.1/reference/dependencies/#citry-ext-dependencies-script) yourself, as a
...
- [HTML fragments](/v/0.3.1/advanced/html-fragments/) covers the `"fragment"` strategy
  for HTMX-style page updates.
- [Add browser behavior](/v/0.3.1/getting-started/browser-interactivity/) introduces
  component JavaScript through one small interaction.
- [Web frameworks](/v/0.3.1/web-frameworks/) shows how to mount Citry so local assets
