---
title: Performance
url: https://citry.dev/v/0.3.1/advanced/performance/
...
[`Const`](/v/0.3.1/reference/rendering/#citry-const).
...
The cache lives on your [`Citry`](/v/0.3.1/reference/citry/#citry-citry) instance and is cleared by
`Citry.clear()`, so there is no global state to reason about across instances.

## Related pages

- [Caching](/v/0.3.1/advanced/caching/) for caching whole rendered components.
- [Rendering](/v/0.3.1/concepts/rendering/) for how a render is produced in the first
  place.