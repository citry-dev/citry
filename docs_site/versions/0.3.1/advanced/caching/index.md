---
title: Caching
url: https://citry.dev/v/0.3.1/advanced/caching/
...
Both use the cache backend configured on your [Citry](/v/0.3.1/reference/citry/#citry-citry) instance.
...
content, caching raises [`CacheKeyError`](/v/0.3.1/reference/cache-keys/#citry-ext-cache-cachekeyerror) unless
...
Pass `cache=` when you construct [Citry](/v/0.3.1/reference/citry/#citry-citry). It accepts a backend
...
`app.cache`. A backend implements the [CitryCache](/v/0.3.1/reference/citry/#citry-citrycache) protocol:
...
[InMemoryCache](/v/0.3.1/reference/citry/#citry-inmemorycache) is thread-safe but process-local. Use a
...
- [Performance](/v/0.3.1/advanced/performance/) for `Const`, which reuses stable pieces
  inside ordinary renders rather than caching a whole subtree.
- [Extensions](/v/0.3.1/advanced/extensions/) for extension lifecycle and metadata.
- [Security](/v/0.3.1/security/) for template and Events trust boundaries.