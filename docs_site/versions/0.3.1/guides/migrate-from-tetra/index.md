...
url: https://citry.dev/v/0.3.1/guides/migrate-from-tetra/
...
The [Events migration parity matrix](/v/0.3.1/guides/events-migration-parity/) records
...
Continue with [event bindings](/v/0.3.1/events/bindings/) and [event
