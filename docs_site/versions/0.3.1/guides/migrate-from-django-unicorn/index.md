...
url: https://citry.dev/v/0.3.1/guides/migrate-from-django-unicorn/
...
[Server events](/v/0.3.1/events/#configure-a-signing-secret-before-using-state)
and these imports:
...
[parity matrix](/v/0.3.1/guides/events-migration-parity/) before porting upload flows.
...
Continue with [State](/v/0.3.1/events/state/), [event bindings](/v/0.3.1/events/bindings/), and
[event actions](/v/0.3.1/events/actions/) for the full Citry workflow. The
[Events migration parity matrix](/v/0.3.1/guides/events-migration-parity/) tracks
