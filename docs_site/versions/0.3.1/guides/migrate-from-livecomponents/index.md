...
url: https://citry.dev/v/0.3.1/guides/migrate-from-livecomponents/
...
[Events migration parity matrix](/v/0.3.1/guides/events-migration-parity/) records
...
Continue with [State](/v/0.3.1/events/state/) and [event actions](/v/0.3.1/events/actions/) for
fresh renders, and [Security](/v/0.3.1/security/) for cache, CSRF, and
