...
url: https://citry.dev/v/0.3.1/events/forms/
...
Start with [Server events](/v/0.3.1/events/) if you have not called a Python handler
...
Raise [`EventError`](/v/0.3.1/reference/events/#citry-ext-events-eventerror) to return a human message and
...
[`$error`](/v/0.3.1/reference/browser-apis/#error) exposes the last failed call. Its `fieldErrors` object uses
...
[`$loading()`](/v/0.3.1/reference/browser-apis/#loading) covers time spent waiting in the queue as well as the
...
The [event bindings guide](/v/0.3.1/events/bindings/) covers submit modifiers and the
other loading and error helpers. [Use event routes directly](/v/0.3.1/events/http/)
