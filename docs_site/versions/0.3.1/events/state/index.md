...
url: https://citry.dev/v/0.3.1/events/state/
...
[`State`](/v/0.3.1/reference/component/#citry-component-state) holds the small values that a later server
...
input. See [Security](/v/0.3.1/security/#treat-state-as-client-input).
...
object. See [Client interactivity](/v/0.3.1/concepts/client-interactivity/) for the
