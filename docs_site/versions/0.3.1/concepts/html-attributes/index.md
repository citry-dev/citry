...
url: https://citry.dev/v/0.3.1/concepts/html-attributes/
...
root or nested element. See [Client interactivity](/v/0.3.1/concepts/client-interactivity/#pass-arbitrary-html-attributes-explicitly).
...
[`format_attrs`](/v/0.3.1/reference/attributes/#citry-format-attrs) turns a dict into an HTML attribute
...
[`merge_attrs`](/v/0.3.1/reference/attributes/#citry-merge-attrs) merges attribute dicts left-to-right. Every
...
[`normalize_style`](/v/0.3.1/reference/attributes/#citry-normalize-style), and
[`parse_string_style`](/v/0.3.1/reference/attributes/#citry-parse-string-style) are the pieces underneath.
