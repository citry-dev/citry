---
title: Components
url: https://citry.dev/v/0.3.1/concepts/components/
...
subclass [`Component`](/v/0.3.1/reference/component/#citry-component), give it a template, and describe how the
...
[Expressions](/v/0.3.1/syntax/expressions/) for what you can put inside them.
...
[Typing and validation](/v/0.3.1/concepts/typing-and-validation/) for what the `Kwargs`
class buys you.
...
**not** return a `Component` instance. It returns a [`CitryElement`](/v/0.3.1/reference/rendering/#citry-citryelement),
...
`render()` returns a [`CitryRender`](/v/0.3.1/reference/rendering/#citry-citryrender) (an object, not a
...
live. For the full picture see [Rendering](/v/0.3.1/concepts/rendering/).
...
named `slots`. See [Slots](/v/0.3.1/concepts/slots/).
...
[Build a page from components](/v/0.3.1/getting-started/build-page/).