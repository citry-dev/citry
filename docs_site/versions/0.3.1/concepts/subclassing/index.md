...
url: https://citry.dev/v/0.3.1/concepts/subclassing/
...
[`Component`](/v/0.3.1/reference/component/#citry-component) the usual way. A few rules govern how the template,
