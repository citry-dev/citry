...
url: https://citry.dev/v/0.4.0/web-frameworks/
...
[HTML fragments](/v/0.4.0/advanced/html-fragments/) for the full fragment flow.

## The default citry instance

Every component attaches to a [Citry](/v/0.4.0/reference/citry/#citry-citry) instance through its
`citry = ...` class attribute. If you do not create one, components use the
ready-made default instance, exported as [citry](/v/0.4.0/reference/citry/#citry-citry-2):
...
[`initialize()`](/v/0.4.0/reference/citry/#citry-citry-initialize) after startup-time registration and
...
[Component discovery and startup](/v/0.4.0/advanced/component-discovery/#initialize-before-starting-worker-threads)
...
[URLRoute](/v/0.4.0/reference/web/#citry-urlroute) objects, and each handler returns a
[RouteResponse](/v/0.4.0/reference/web/#citry-routeresponse) the sub-app translates to the host's
response type.
...
[Server events](/v/0.4.0/events/) for the handler workflow and
[Security](/v/0.4.0/security/#protect-event-posts-from-csrf) before deploying those
routes.
