---
title: Install Citry
url: https://citry.dev/v/0.4.0/getting-started/installation/
...
[`Component`](/v/0.4.0/reference/component/#citry-component) base class:
...
see [Compatibility](/v/0.4.0/about/compatibility/#building-from-source) for the
platform and Rust requirements.

## Next steps

Citry is installed and ready to render HTML. Next,
[build a reusable card](/v/0.4.0/getting-started/your-first-component/) with an option,
