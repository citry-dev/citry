---
title: Events state
url: https://citry.dev/v/0.4.0/getting-started/state/
...
- the [`State`](/v/0.4.0/reference/component/#citry-component-state) declaration and stateful handler
...
already been loaded. Use [`State`](/v/0.4.0/reference/component/#citry-component-state) to store that info:
...
[`Kwargs`](/v/0.4.0/reference/component/#citry-component-kwargs) and [`State`](/v/0.4.0/reference/component/#citry-component-state) answer two
different questions:
...
Defining [`state_data()`](/v/0.4.0/events/state/#choose-what-survives-in-state)
...
[dynamic attribute](/v/0.4.0/syntax/dynamic-attributes/). Citry evaluates the Python
...
Next, [handle and validate forms](/v/0.4.0/getting-started/forms/) whose values come
