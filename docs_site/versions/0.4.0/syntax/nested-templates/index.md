...
url: https://citry.dev/v/0.4.0/syntax/nested-templates/
...
The receiving component gets a [`CitryRender`](/v/0.4.0/reference/rendering/#citry-citryrender), not a plain
...
[`<c-fill>`](/v/0.4.0/reference/builtins/#c-fill) are usually clearer. Use markup in an
...
Read [Attributes](/v/0.4.0/syntax/dynamic-attributes/) for expression-valued inputs and
[Slots](/v/0.4.0/concepts/slots/) for the usual way to pass flexible content into a
component.