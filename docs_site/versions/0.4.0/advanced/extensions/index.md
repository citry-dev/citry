---
title: Extensions
url: https://citry.dev/v/0.4.0/advanced/extensions/
...
Extensions belong to one [`Citry`](/v/0.4.0/reference/citry/#citry-citry) instance. Only components
...
extensions. Other bundled extensions, such as [`Debug`](/v/0.4.0/reference/extensions/#citry-ext-debug-debug),
are opt-in. See [Troubleshooting](/v/0.4.0/guides/troubleshooting/) for using `Debug`
while investigating rendered output.

## Add behavior with a lifecycle hook

Subclass [`Extension`](/v/0.4.0/reference/extensions/#citry-extension), give it a lowercase `name`, and
...
[`Extension` reference](/v/0.4.0/reference/extensions/#citry-extension) for every hook and its context.
...
[`ExtensionManager.emit()`](/v/0.4.0/reference/extensions/#citry-extensionmanager-emit) for the exact
contract.
...
[Caching](/v/0.4.0/advanced/caching/) and the extension cache methods in the
[`Extension` reference](/v/0.4.0/reference/extensions/#citry-extension).
...
The handler receives a [`RouteRequest`](/v/0.4.0/reference/web/#citry-routerequest) and returns a
[`RouteResponse`](/v/0.4.0/reference/web/#citry-routeresponse). A route accepts `GET` by default. Pass
...
See [Web frameworks](/v/0.4.0/web-frameworks/) for mounting `app.urls` in your
host application.
...
See [Command line](/v/0.4.0/cli/) for defining arguments and running
extension commands.

## Related reference

- [`Extension`](/v/0.4.0/reference/extensions/#citry-extension)
- [`ExtensionManager`](/v/0.4.0/reference/extensions/#citry-extensionmanager)
- [`ExtensionConfig`](/v/0.4.0/reference/extensions/#citry-extensionconfig)
- [`ExtensionCommand`](/v/0.4.0/reference/extensions/#citry-extensioncommand)
- [`URLRoute`](/v/0.4.0/reference/web/#citry-urlroute)
- [`RouteRequest`](/v/0.4.0/reference/web/#citry-routerequest)
- [`RouteResponse`](/v/0.4.0/reference/web/#citry-routeresponse)