...
url: https://citry.dev/v/0.4.0/advanced/component-discovery/
...
Create one [`Citry`](/v/0.4.0/reference/citry/#citry-citry) instance in a module that every component can
import:
...
Call [`initialize()`](/v/0.4.0/reference/citry/#citry-citry-initialize) before starting worker threads.
...
[Web frameworks](/v/0.4.0/web-frameworks/) for framework-specific setup.

## Run discovery explicitly

Use [`autodiscover()`](/v/0.4.0/reference/citry/#citry-citry-autodiscover) when you want the imported
...
[`initialize()`](/v/0.4.0/reference/citry/#citry-citry-initialize) once during startup, then let request
workers use the prepared engine.

## Related reference

- [`Citry`](/v/0.4.0/reference/citry/#citry-citry)
- [`Citry.initialize()`](/v/0.4.0/reference/citry/#citry-citry-initialize)
- [`Citry.autodiscover()`](/v/0.4.0/reference/citry/#citry-citry-autodiscover)
- [Registration](/v/0.4.0/concepts/registration/)
- [Hot reload](/v/0.4.0/guides/dev-server/)