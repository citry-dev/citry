---
title: Accordion
url: https://citry.dev/v/0.4.0/ui-library/components/accordion/
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/basic-accordion/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/controlled-value/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/expansion-modes/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/actions/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/disabled-items/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/nested-accordion/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/variants/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/accordion/_previews/customization/)
