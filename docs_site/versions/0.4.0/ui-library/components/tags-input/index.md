---
title: TagsInput
url: https://citry.dev/v/0.4.0/ui-library/components/tags-input/
...
Use [MultiSelect](/v/0.4.0/ui-library/components/multi-select/) when choices come from
...
[Tag and TagGroup](/v/0.4.0/ui-library/components/tag/) to display tags without an
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/basic-tags/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/controlled-axes/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/paste-and-ime/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/forms-and-reset/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/field-states/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/keyboard-and-focus/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/variants-and-sizes/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/customization/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/tags-input/_previews/morph-and-cleanup/)
