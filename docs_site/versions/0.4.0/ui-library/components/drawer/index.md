---
title: Drawer
url: https://citry.dev/v/0.4.0/ui-library/components/drawer/
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/at-a-glance/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/edit-field-note/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/bottom-sheet/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/configuration/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/controlled-drawer/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/long-content/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/drawer-form/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/nested-layers/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/explicit-completion/)
...
[Open the rendered preview](/v/0.4.0/ui-library/components/drawer/_previews/customization/)
