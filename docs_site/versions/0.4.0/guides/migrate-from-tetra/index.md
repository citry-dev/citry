...
url: https://citry.dev/v/0.4.0/guides/migrate-from-tetra/
...
The [Events migration parity matrix](/v/0.4.0/guides/events-migration-parity/) records
...
Continue with [event bindings](/v/0.4.0/events/bindings/) and [event
