...
url: https://citry.dev/v/0.4.0/guides/migrate-from-component-view/
...
[Protect event posts from CSRF](/v/0.4.0/security/#protect-event-posts-from-csrf).
...
Continue with the [Events guides](/v/0.4.0/events/) for the full API, or use the
[Events migration parity matrix](/v/0.4.0/guides/events-migration-parity/) to
