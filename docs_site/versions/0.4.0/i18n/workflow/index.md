...
url: https://citry.dev/v/0.4.0/i18n/workflow/
...
Set the application policy with [`LintSettings`](/v/0.4.0/reference/citry/#citry-lintsettings):
...
[Production and deployment](/v/0.4.0/i18n/production/) for the package requirements.
...
See [VS Code](/v/0.4.0/ide/vscode/) for project setup and the boundary between
