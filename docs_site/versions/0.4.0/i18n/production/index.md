...
url: https://citry.dev/v/0.4.0/i18n/production/
...
[Organize catalogs](/v/0.4.0/i18n/catalogs/#create-a-catalog-package). Other build
...
See [Browser i18n](/v/0.4.0/i18n/browser/) for the authoring API and the difference
