...
url: https://citry.dev/v/0.4.0/concepts/error-boundaries/
...
Citry provides the
[`<c-error-fallback>` built-in](/v/0.4.0/reference/builtins/#c-error-fallback). It
...
[Slots](/v/0.4.0/concepts/slots/). For the wider server render lifecycle, see
