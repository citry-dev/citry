---
title: Registration
url: https://citry.dev/v/0.4.0/concepts/registration/
...
[`Citry`](/v/0.4.0/reference/citry/#citry-citry) instance can use its tag.

If importing every component module by hand becomes unwieldy, read
[Component discovery](/v/0.4.0/advanced/component-discovery/) after this page.

## Register a component when its class is defined

A concrete [`Component`](/v/0.4.0/reference/component/#citry-component) registers as soon as Python defines
...
Every component belongs to one [`Citry`](/v/0.4.0/reference/citry/#citry-citry) instance. Components
without an explicit owner use the shared [`citry`](/v/0.4.0/reference/citry/#citry-citry-2) instance.
...
Use [`register()`](/v/0.4.0/reference/citry/#citry-citry-register) to give an existing component another
...
[component library](/v/0.4.0/advanced/component-libraries/) with deliberate public
names.
...
[`AlreadyRegistered`](/v/0.4.0/reference/citry/#citry-alreadyregistered). Built-in and structural tag
names are reserved and produce the same error. Looking up a name that does not
exist raises [`NotRegistered`](/v/0.4.0/reference/citry/#citry-notregistered).
...
[Component discovery](/v/0.4.0/advanced/component-discovery/) shows the directory
