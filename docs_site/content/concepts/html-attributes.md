...
root or nested element. See [Client interactivity](/concepts/client-interactivity/#pass-arbitrary-html-attributes-explicitly).
...
[`format_attrs`][citry.format_attrs] turns a dict into an HTML attribute
...
[`merge_attrs`][citry.merge_attrs] merges attribute dicts left-to-right. Every
...
[`normalize_class`][citry.normalize_class],
[`normalize_style`][citry.normalize_style], and
[`parse_string_style`][citry.parse_string_style] are the pieces underneath.
