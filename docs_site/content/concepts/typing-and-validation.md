...
Add a `class Kwargs:` to your [Component][citry.Component] and list each prop
...
See [Slots](/concepts/slots/) for how to fill and default slot content.
...
fit together more broadly, see [Components](/concepts/components/) and
[Use data in components](/getting-started/data-in-components/).
...
See [JS and CSS dependencies](/advanced/js-and-css-dependencies/) for how a component
...
name. See [Subclassing](/concepts/subclassing/) for more on extending components.
