...
[`$component()` callback](/advanced/js-and-css-dependencies/#add-behavior-and-styles).
...
boundary, use
[`$c-props`](/concepts/client-interactivity/#pass-client-props-down).
...
Read [Alpine runtime](/advanced/alpine-runtime/#choose-the-right-kind-of-loop-or-condition)
...
The [Browser APIs reference](/reference/browser-apis/#alpine-magics) gives the
