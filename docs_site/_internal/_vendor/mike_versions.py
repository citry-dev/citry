...
#
# Why vendored: citry persists built docs versions to the repo (under
# docs_site/versions/) rather than a gh-pages branch, so we don't need mike's git
# or mkdocs machinery - only its version-manifest data model and the version
# ordering (dev/sentinel versions sort above releases).
#
